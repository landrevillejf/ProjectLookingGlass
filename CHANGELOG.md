...
- **Games in the 2D/Swing desktop** (`lg3d-incubator`, `lg3d-core`) — the four
  ...
  keyboard-editable fields with a difficulty combo and conflict highlighting; an 8x8
  click-to-move button board with Unicode piece glyphs; a custom-painted Klondike
  table with click-to-select / click-to-move and double-click-to-foundation) that
  reuse each game's **AWT-free engine** (`TicTacToeModel`, `SudokuModel`,
  ...
  (40 tests), `Desktop2DAppRegistryTest` asserts the four commands classify as
