...
//        polyAttr.setPolygonMode(PolygonAttributes.POLYGON_LINE);
    ...
    class ClothBehavior extends org.jogamp.java3d.Behavior {
        private org.jogamp.java3d.WakeupCriterion wakeupContinuous = new org.jogamp.java3d.WakeupOnElapsedFrames(0);
        private org.jogamp.java3d.WakeupCriterion wakeupStep = new org.jogamp.java3d.WakeupOnBehaviorPost(this,0);
        
        private org.jogamp.java3d.WakeupCondition wakeup = wakeupContinuous;
...
//            skipCount=0;
            ...
            org.jogamp.java3d.GeometryArray j3dGeom = getImplementationNode(geom);
...
//            j3dGeom.setCoordinates(0,coords);
            j3dGeom.updateData( new org.jogamp.java3d.GeometryUpdater() {
         ...
         */
        private org.jogamp.java3d.GeometryArray getImplementationNode(GeometryArray lgBg) {
            Object obj;
            org.jdesktop.lg3d.sg.internal.wrapper.SceneGraphObjectWrapper w = lgBg.getWrapped();
            org.jogamp.java3d.GeometryArray ret = null;
            ...
            while( ret==null ) {
                ...
                else if (obj instanceof org.jogamp.java3d.GeometryArray)
                    ret = (org.jogamp.java3d.GeometryArray)obj;
            }
