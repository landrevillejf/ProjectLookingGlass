 ...
 *
 * $RCSfile: JawtVolatileImage.java,v $
 *
 ...
 * @author paulby
 */
public class JawtVolatileImage extends VolatileImage {
    
    private BufferedImage image;
    
    /** Creates a new instance of JawtVolatileImage */
    public JawtVolatileImage(int width, int height) {
