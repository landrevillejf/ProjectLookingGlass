...
/**
 * A desktop clock with analog and digital faces. Clicking the widget toggles
...
public class ClockWidget extends AbstractWidget {
    ...
    private final class ClockPanel extends WidgetPanel {
        ClockPanel() {
            super("Clock", 150, 150);
        }
