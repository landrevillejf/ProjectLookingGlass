 ...
 *
 * <p>Pure Swing: the 3D {@link CpuWidget} and the 2D desktop layer both host
 * this same card.</p>
 */
public class CpuCard extends WidgetCard {
    ...
    protected void paintContent(Graphics2D g2, int w, int h, int top) {
        ...
        Color col = TemperatureCard.colorFor(40.0 + p * 0.5);
        g2.setColor(col);
        int tx = 12;
