 ...
 * periodically; clicking the card cycles through the available zones. When no
 * thermal sensor is exposed (common in VMs) it shows "n/a" rather than failing.
 *
 * <p>Pure Swing: the 3D {@link TemperatureWidget} and the 2D desktop layer both
 * host this same card.</p>
 */
public class TemperatureCard extends WidgetCard {
    ...
    /** Cool / warm / hot colour ramp shared by the temperature and CPU cards. */
