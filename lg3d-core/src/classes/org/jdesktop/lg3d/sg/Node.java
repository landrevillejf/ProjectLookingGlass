...
public abstract class Node extends SceneGraphObject {
    ...
    ENABLE_PICK_REPORTING = org.jogamp.java3d.Node.ENABLE_PICK_REPORTING;
     ...
     */  
    public static final int
    ENABLE_COLLISION_REPORTING = org.jogamp.java3d.Node.ENABLE_COLLISION_REPORTING;
     ...
     */
    public static final int
    ALLOW_BOUNDS_READ = org.jogamp.java3d.Node.ALLOW_BOUNDS_READ;
     ...
     */
    public static final int
    ALLOW_BOUNDS_WRITE = org.jogamp.java3d.Node.ALLOW_BOUNDS_WRITE;

    /**
     * Specifies that this Node allows reading its pickability state.
     */
    public static final int
    ALLOW_PICKABLE_READ = org.jogamp.java3d.Node.ALLOW_PICKABLE_READ;

    /**
     * Specifies that this Node allows write access its pickability state.
     */
    public static final int
    ALLOW_PICKABLE_WRITE = org.jogamp.java3d.Node.ALLOW_PICKABLE_WRITE;

    /**
     * Specifies that this Node allows reading its collidability state.
     */
    public static final int
    ALLOW_COLLIDABLE_READ = org.jogamp.java3d.Node.ALLOW_COLLIDABLE_READ;

    /**
     * Specifies that this Node allows write access its collidability state.
     */
    public static final int
    ALLOW_COLLIDABLE_WRITE = org.jogamp.java3d.Node.ALLOW_COLLIDABLE_WRITE;
     ...
     */
    public static final int
    ALLOW_AUTO_COMPUTE_BOUNDS_READ = org.jogamp.java3d.Node.ALLOW_AUTO_COMPUTE_BOUNDS_READ;
     ...
     */
    public static final int
    ALLOW_AUTO_COMPUTE_BOUNDS_WRITE = org.jogamp.java3d.Node.ALLOW_AUTO_COMPUTE_BOUNDS_WRITE;
     ...
     */
    public static final int
    ALLOW_LOCAL_TO_VWORLD_READ = org.jogamp.java3d.Node.ALLOW_LOCAL_TO_VWORLD_READ;
    
    /**
     * Specifies that this Node allows read access to its parent Group node.
     */
    public static final int
    ALLOW_PARENT_READ = org.jogamp.java3d.Node.ALLOW_PARENT_READ;
