...
public final class PickBounds extends PickShape {
    ...
    public PickBounds() {
	bounds = null;
	wrapped = new org.jogamp.java3d.PickBounds();
    }
...
//	bounds = boundsObject;
//	wrapped = new org.jogamp.java3d.PickBounds( bounds.wrapped );
...
//	bounds = boundsObject;
//        ((org.jogamp.java3d.PickBounds)wrapped).set( bounds.wrapped );
        throw new RuntimeException("Not Implemented");
    }
