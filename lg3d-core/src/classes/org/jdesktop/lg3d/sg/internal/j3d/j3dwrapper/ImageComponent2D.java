...
//        wrapped = new org.jogamp.java3d.ImageComponent2D( format, width, height );
    ...
    public ImageComponent2D(int		format,
			    ...
			    boolean	yUp) {
        assert(this.getClass()==ImageComponent2D.class);
//         wrapped = new org.jogamp.java3d.ImageComponent2D( format, 
//                                                         width, 
//                                                         height,
//                                                         byReference,
//                                                         yUp );
...
//                                                        yUp );
    ...
    public void set(BufferedImage image) {
        ((org.jogamp.java3d.ImageComponent2D)wrapped).set( image );
    }
    ...
    public void setSubImage(RenderedImage image, int width, int height,
        ...
        ((org.jogamp.java3d.ImageComponent2D)wrapped).setSubImage( image,
                                                                 width,
                                                                 height,
                                                                 srcX,
                                                                 srcY,
