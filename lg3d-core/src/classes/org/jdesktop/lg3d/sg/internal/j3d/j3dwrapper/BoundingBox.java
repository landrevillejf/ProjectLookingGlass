...
public class BoundingBox extends Bounds implements BoundingBoxWrapper {
    ...
    public BoundingBox(Bounds[] bounds) {
        throw new RuntimeException("Not implemented");
      	//wrapped = new org.jogamp.java3d.BoundingBox( bounds );
    }
    
    protected void createWrapped() {
	wrapped = new org.jogamp.java3d.BoundingBox();
   ...
   /**
    ...
    public void getLower(Point3f p1) {
        ...
        ((org.jogamp.java3d.BoundingBox)wrapped).getLower( p3d );
    ...
    public void getUpper(Point3f p1) {
        Point3d p3d = new Point3d();
        ((org.jogamp.java3d.BoundingBox)wrapped).getUpper( p3d );
    ...
    public void setLower(float xmin, float ymin, float zmin ) {
        ((org.jogamp.java3d.BoundingBox)wrapped).setLower( xmin, ymin, zmin );
    }
    ...
    public void setUpper(float xmax, float ymax, float zmax ) {
        ((org.jogamp.java3d.BoundingBox)wrapped).setUpper( xmax, ymax, zmax );
    }
    ...
    public void set(BoundsWrapper  boundsObject) {
      ((org.jogamp.java3d.BoundingBox)wrapped).set( ((Bounds)boundsObject).wrapped );
    }
	...
	return ((org.jogamp.java3d.BoundingBox)wrapped).equals( bounds );
    }
     ...
     */
    public int hashCode() {
	return ((org.jogamp.java3d.BoundingBox)wrapped).hashCode();
    }
    ...
    public void combine(BoundsWrapper boundsObject) {
        ((org.jogamp.java3d.BoundingBox)wrapped).combine( ((Bounds)boundsObject).wrapped );
    }
    ...
    public void combine(BoundsWrapper[] bounds) {
       ...
       //((org.jogamp.java3d.BoundingBox)wrapped).combine( 
    }
	...
	((org.jogamp.java3d.BoundingBox)wrapped).transform( ((Bounds)boundsObject).wrapped, ((Transform3D)matrix).wrapped );
    }
    ...
    public void transform(Transform3DWrapper matrix) {
        ((org.jogamp.java3d.BoundingBox)wrapped).transform( ((Transform3D)matrix).wrapped );
    }
    ...
    public boolean intersect(Point3d origin, Vector3d direction ) {
        ...
        return ((org.jogamp.java3d.BoundingBox)wrapped).intersect( origin, direction );
    }
    ...
    public boolean intersect(Point3d point ) {
        ...
        return ((org.jogamp.java3d.BoundingBox)wrapped).intersect( point );
    }
    ...
    public boolean intersect(Point3f point ) {
        ...
        return ((org.jogamp.java3d.BoundingBox)wrapped).intersect( new Point3d(point) );
    }
    ...
    public boolean isEmpty() {
	 ...
	 return ((org.jogamp.java3d.BoundingBox)wrapped).isEmpty();
    }
	...
	return ((org.jogamp.java3d.BoundingBox)wrapped).intersect( ((Bounds)boundsObject).wrapped );
    }
	...
	return ((org.jogamp.java3d.BoundingBox)wrapped).intersect( ((Bounds)boundsObject).wrapped, 
                            (org.jogamp.java3d.BoundingBox)((BoundingBox)newBoundBox).wrapped );
    }
...
//	 Point3d p3d = ((org.jogamp.java3d.BoundingBox)wrapped).getCenter();
//         
