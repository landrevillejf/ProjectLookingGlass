...
public abstract class GeometryArray extends Geometry implements GeometryArrayWrapper {
  ...
  public static final int TEXTURE_COORDINATE_2 = 0x20;
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getVertexCount();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getVertexFormat();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getTexCoordSetCount();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getTexCoordSetMapLength();
    }
    ...
    public void getTexCoordSetMap(int[] texCoordSetMap) {
        ((org.jogamp.java3d.GeometryArray)wrapped).getTexCoordSetMap(texCoordSetMap);
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setValidVertexCount(validVertexCount);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getValidVertexCount();
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setInitialVertexIndex(initialVertexIndex);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInitialVertexIndex();
    }
  ...
  public void setCoordinate(int index, float coordinate[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setCoordinate(index, coordinate);
  }
  ...
  public void setCoordinates(int index, float coordinates[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setCoordinates(index, coordinates);
//    try {
...
//    }
  ...
  public void setColor(int index, float color[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setColor(index, color);
  }
  ...
  public void setColors(int index, float colors[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setColors(index, colors);
//    try {
...
//    }
  ...
  public void setColors(int index, float colors[],
				   int start, int length) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setColors(index, colors, start,
                                                length);
  }
  ...
  public void setNormal(int index, float normal[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setNormal(index, normal);
  }
  ...
  public void setNormals(int index, float normals[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setNormals(index, normals);
  }
  ...
  public void setNormals(int index, float normals[],
				   int start, int length) {
    ((org.jogamp.java3d.GeometryArray)wrapped).setNormals(index, normals, start,                                                    length);
  }
  ...
  public void setNormals(int index, Vector3f normals[],
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setTextureCoordinates(
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setTextureCoordinate( index, texCoord);
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setTextureCoordinate(
		texCoordSet, index, texCoord);
    }
  ...
  public void getCoordinate(int index, float coordinate[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getCoordinate(index, coordinate);
  }
  ...
  public void getCoordinates(int index, float coordinates[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getCoordinates(index, coordinates);
  }
  ...
  public void getColor(int index, float color[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getColor(index, color);
  }
  ...
  public void getColors(int index, float colors[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getColors(index, colors);
  }
  ...
  public void getNormal(int index, float normal[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getNormal(index, normal);
  }
  ...
  public void getNormals(int index, float normals[]) {
    ((org.jogamp.java3d.GeometryArray)wrapped).getNormals(index, normals);
  }
  ...
  public void getNormals(int index, Vector3f normals[]) {
    ...
    public void getTextureCoordinate(int texCoordSet,
				     int index, float texCoord[]) {
	((org.jogamp.java3d.GeometryArray)wrapped).getTextureCoordinate(
				texCoordSet, index, texCoord);
    }
    ...
    public void getTextureCoordinates(int texCoordSet,
				      int index, float texCoords[]) {
	((org.jogamp.java3d.GeometryArray)wrapped).getTextureCoordinates(
				texCoordSet, index, texCoords);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInitialCoordIndex();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInitialColorIndex();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInitialNormalIndex();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInitialTexCoordIndex(
							texCoordSet);
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setCoordRefFloat(coords);
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getCoordRefFloat();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getCoordRef3f();
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setColorRefFloat(colors);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getColorRefFloat();
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setColorRef3f(colors);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getColorRef3f();
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setNormalRefFloat(normals);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getNormalRefFloat();
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getNormalRef3f();
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setTexCoordRefFloat(
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getTexCoordRefFloat(
							texCoordSet);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getTexCoordRef2f(
							texCoordSet);
    }
	...
	((org.jogamp.java3d.GeometryArray)wrapped).setInterleavedVertices(vertexData);
    }
	...
	return ((org.jogamp.java3d.GeometryArray)wrapped).getInterleavedVertices();
    }
}
