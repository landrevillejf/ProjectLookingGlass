...
public class Material extends NodeComponent implements MaterialWrapper {
   ...
   */
	...
	wrapped = new org.jogamp.java3d.Material();
	...
	((org.jogamp.java3d.Material)wrapped).setAmbientColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setAmbientColor( r,g,b );
    }
	...
	((org.jogamp.java3d.Material)wrapped).getAmbientColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setEmissiveColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setEmissiveColor( r,g,b );
    }
	...
	((org.jogamp.java3d.Material)wrapped).getEmissiveColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setDiffuseColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setDiffuseColor( r,g,b );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setDiffuseColor( r,g,b,a );
    }
	...
	((org.jogamp.java3d.Material)wrapped).getDiffuseColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setSpecularColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setSpecularColor( r,g,b );
    }
	...
	((org.jogamp.java3d.Material)wrapped).getSpecularColor( color );
    }
	...
	((org.jogamp.java3d.Material)wrapped).setShininess( shininess );
    }
	...
	return ((org.jogamp.java3d.Material)wrapped).getShininess();
    }
	...
	((org.jogamp.java3d.Material)wrapped).setLightingEnable( state );
    }
	...
	return ((org.jogamp.java3d.Material)wrapped).getLightingEnable();
    }
	...
	((org.jogamp.java3d.Material)wrapped).setColorTarget( colorTarget );
    }
	...
	return ((org.jogamp.java3d.Material)wrapped).getColorTarget();
    }
	...
	return ((org.jogamp.java3d.Material)wrapped).toString();
    }
