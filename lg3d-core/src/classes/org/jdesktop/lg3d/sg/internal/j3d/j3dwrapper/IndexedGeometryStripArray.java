...
public abstract class IndexedGeometryStripArray extends IndexedGeometryArray implements IndexedGeometryStripArrayWrapper {
   ...
   */
	...
	return ((org.jogamp.java3d.IndexedGeometryStripArray)wrapped).getNumStrips();
    }
    ...
    public void setStripIndexCounts(int[] stripIndexCounts) {
        ((org.jogamp.java3d.IndexedGeometryStripArray)wrapped).setStripIndexCounts(stripIndexCounts);
    }
    ...
    public void getStripIndexCounts(int[] stripIndexCounts) {
        ((org.jogamp.java3d.IndexedGeometryStripArray)wrapped).getStripIndexCounts(stripIndexCounts);
    }
