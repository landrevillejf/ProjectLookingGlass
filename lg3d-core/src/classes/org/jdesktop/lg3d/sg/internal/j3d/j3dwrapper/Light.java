...
public abstract class Light extends Leaf implements LightWrapper {
	...
	((org.jogamp.java3d.Light)wrapped).setEnable( state );
    }
	...
	return ((org.jogamp.java3d.Light)wrapped).getEnable();
    }
	...
	((org.jogamp.java3d.Light)wrapped).setColor( color );
    }
	...
	((org.jogamp.java3d.Light)wrapped).getColor( color );
    }
	...
	((org.jogamp.java3d.Light)wrapped).setScope( (org.jogamp.java3d.Group)((Group)scope).wrapped, index );
    }
	...
	return (GroupWrapper)((org.jogamp.java3d.Light)wrapped).getScope(index).getUserData();
    }
	...
	((org.jogamp.java3d.Light)wrapped).insertScope( (org.jogamp.java3d.Group)((Group)scope).wrapped, index );
    }
	...
	((org.jogamp.java3d.Light)wrapped).removeScope( index );
    }
	...
	java.util.Iterator e = ((org.jogamp.java3d.Light)wrapped).getAllScopes();
        java.util.Vector v = new java.util.Vector();
        while(e.hasNext())
            v.add( ((org.jogamp.java3d.Group)e.next()).getUserData() );
	...
	((org.jogamp.java3d.Light)wrapped).addScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
    }
	...
	return ((org.jogamp.java3d.Light)wrapped).numScopes();
    }
	...
	return ((org.jogamp.java3d.Light)wrapped).indexOfScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
    }
	...
	((org.jogamp.java3d.Light)wrapped).removeScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
    }
	...
	((org.jogamp.java3d.Light)wrapped).removeAllScopes();
    }
    ...
    public void setInfluencingBounds(BoundsWrapper region) {
    	((org.jogamp.java3d.Light)wrapped).setInfluencingBounds( ((Bounds)region).wrapped );
    }
    ...
    public BoundsWrapper getInfluencingBounds() {
    	org.jogamp.java3d.Bounds j3dBounds = ((org.jogamp.java3d.Light)wrapped).getInfluencingBounds();
