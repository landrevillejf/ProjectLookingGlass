...
public class BranchGroup extends Group implements BranchGroupWrapper {
   ...
   */
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.BranchGroup();
   ...
   */
    public void detach() {
       ((org.jogamp.java3d.BranchGroup)wrapped).detach();
  }
   ...
   */
    public SceneGraphPathWrapper[] pickAll( PickShapeWrapper pickShape ) {
        org.jogamp.java3d.SceneGraphPath[] j3dSGP = ((org.jogamp.java3d.BranchGroup)wrapped).pickAll( (org.jogamp.java3d.PickShape)((PickShape)pickShape).wrapped );
        if (j3dSGP==null)
            return null;
   ...
   */
    public SceneGraphPathWrapper[] pickAllSorted( PickShapeWrapper pickShape ) {
        org.jogamp.java3d.SceneGraphPath[] j3dSGP = ((org.jogamp.java3d.BranchGroup)wrapped).pickAllSorted( (org.jogamp.java3d.PickShape)((PickShape)pickShape).wrapped );
        if (j3dSGP==null)
            return null;
   ...
   */
    public SceneGraphPathWrapper pickClosest( PickShapeWrapper pickShape ) {
        return new SceneGraphPath(((org.jogamp.java3d.BranchGroup)wrapped).pickClosest((org.jogamp.java3d.PickShape)((PickShape)pickShape).wrapped ));
    }
   ...
   */
    public SceneGraphPathWrapper pickAny( PickShapeWrapper pickShape ) {
        return new SceneGraphPath(((org.jogamp.java3d.BranchGroup)wrapped).pickAny( (org.jogamp.java3d.PickShape)((PickShape)pickShape).wrapped ));
    }
