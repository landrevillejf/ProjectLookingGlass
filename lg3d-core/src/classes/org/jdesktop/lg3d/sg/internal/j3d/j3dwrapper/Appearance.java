...
public class Appearance extends NodeComponent implements AppearanceWrapper {
  ...
  public static final int ALLOW_TEXTURE_UNIT_STATE_WRITE =
	...
	wrapped = new org.jogamp.java3d.Appearance();
    ...
    public void setMaterial(MaterialWrapper material) {
        if (material==null)
            ((org.jogamp.java3d.Appearance)wrapped).setMaterial( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setMaterial( (org.jogamp.java3d.Material)((Material)material).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getMaterial();
    ...
    public void setColoringAttributes(ColoringAttributesWrapper coloringAttributes) {
        if (coloringAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setColoringAttributes( null );
        else    
            ((org.jogamp.java3d.Appearance)wrapped).setColoringAttributes( (org.jogamp.java3d.ColoringAttributes)((ColoringAttributes)coloringAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getColoringAttributes();
    ...
    public void setLineAttributes(LineAttributesWrapper lineAttributes) {
        if (lineAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setLineAttributes( null );
        else    
            ((org.jogamp.java3d.Appearance)wrapped).setLineAttributes( (org.jogamp.java3d.LineAttributes)((LineAttributes)lineAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getLineAttributes();
    ...
    public void setTransparencyAttributes(TransparencyAttributesWrapper transparencyAttributes) {
        if (transparencyAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setTransparencyAttributes( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setTransparencyAttributes( (org.jogamp.java3d.TransparencyAttributes)((TransparencyAttributes)transparencyAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getTransparencyAttributes();
    ...
    public void setRenderingAttributes(RenderingAttributesWrapper renderingAttributes) {
        if (renderingAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setRenderingAttributes( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setRenderingAttributes( (org.jogamp.java3d.RenderingAttributes)((RenderingAttributes)renderingAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getRenderingAttributes();
    ...
    public void setPolygonAttributes(PolygonAttributesWrapper polygonAttributes) {
        if (polygonAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setPolygonAttributes( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setPolygonAttributes( (org.jogamp.java3d.PolygonAttributes)((PolygonAttributes)polygonAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getPolygonAttributes();
    ...
    public void setTexture(TextureWrapper texture) {
        if (texture==null)
            ((org.jogamp.java3d.Appearance)wrapped).setTexture( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setTexture( (org.jogamp.java3d.Texture)((Texture)texture).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getTexture();
    ...
    public void setTextureAttributes(TextureAttributesWrapper textureAttributes) {
        if (textureAttributes==null)
            ((org.jogamp.java3d.Appearance)wrapped).setTextureAttributes( null );
        else
            ((org.jogamp.java3d.Appearance)wrapped).setTextureAttributes( (org.jogamp.java3d.TextureAttributes)((TextureAttributes)textureAttributes).wrapped );
    }
	...
	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getTextureAttributes();
...
//	org.jogamp.java3d.SceneGraphObject obj = ((org.jogamp.java3d.Appearance)wrapped).getTextureUnitState( index );
//        
//        if (obj==null)
//            return null;
//        
...
//	return ((org.jogamp.java3d.Appearance)wrapped).getTextureUnitCount();
//    }
