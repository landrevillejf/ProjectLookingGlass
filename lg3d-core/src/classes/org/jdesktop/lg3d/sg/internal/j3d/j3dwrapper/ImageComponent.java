...
public abstract class ImageComponent extends NodeComponent implements ImageComponentWrapper {
  ...
  // Change this if any more formats are added or removed
     ...
     */  
    public int getWidth() {
        return ((org.jogamp.java3d.ImageComponent)wrapped).getWidth();
    }
    ...
    public int getHeight() {
        return ((org.jogamp.java3d.ImageComponent)wrapped).getHeight();
    }
    ...
    public int getFormat() {
        return ((org.jogamp.java3d.ImageComponent)wrapped).getFormat();
    }
    ...
    public boolean isByReference() {
        return ((org.jogamp.java3d.ImageComponent)wrapped).isByReference();
    }
    ...
    public void setYUp(boolean yUp) {
        ((org.jogamp.java3d.ImageComponent)wrapped).setYUp( yUp );
    }
    ...
    public boolean isYUp() {
        return ((org.jogamp.java3d.ImageComponent)wrapped).isYUp();
    }
