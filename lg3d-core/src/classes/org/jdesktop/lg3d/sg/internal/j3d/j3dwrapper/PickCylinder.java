...
public abstract class PickCylinder extends PickShape {
	...
	((org.jogamp.java3d.PickCylinder)wrapped).getOrigin( p3d );
        origin.set(p3d);
     }
	...
	return 	(float)((org.jogamp.java3d.PickCylinder)wrapped).getRadius();
	...
	((org.jogamp.java3d.PickCylinder)wrapped).getDirection( v3d );
        direction.set(v3d);
    }
