...
public class ExponentialFog extends Fog implements ExponentialFogWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.ExponentialFog();
    ...
    public void setDensity(float density) {
        ((org.jogamp.java3d.ExponentialFog)wrapped).setDensity(density);
    }
    ...
    public float getDensity() {
        return ((org.jogamp.java3d.ExponentialFog)wrapped).getDensity();
    }
