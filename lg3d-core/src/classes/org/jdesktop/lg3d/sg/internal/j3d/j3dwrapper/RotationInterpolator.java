...
public class RotationInterpolator extends Node implements RotationInterpolatorWrapper {
	...
	wrapped = new org.jogamp.java3d.RotationInterpolator( (org.jogamp.java3d.Alpha)((Alpha)alpha).wrapped,
                                (org.jogamp.java3d.TransformGroup)((TransformGroup)target).wrapped);
        wrapped.setUserData(this);
	org.jogamp.java3d.BoundingSphere bounds =
	    new org.jogamp.java3d.BoundingSphere(new org.jogamp.vecmath.Point3d(0.0,0.0,0.0), 100.0f);
	((org.jogamp.java3d.RotationInterpolator)wrapped).setSchedulingBounds(bounds);
    }
	...
	wrapped = new org.jogamp.java3d.RotationInterpolator( (org.jogamp.java3d.Alpha)((Alpha)alpha).wrapped,
                                (org.jogamp.java3d.TransformGroup)((TransformGroup)target).wrapped,
                                (org.jogamp.java3d.Transform3D)((Transform3D)axisOfTransform).wrapped,
	...
	((org.jogamp.java3d.RotationInterpolator)wrapped).setMinimumAngle( angle );
    }
	...
	return ((org.jogamp.java3d.RotationInterpolator)wrapped).getMinimumAngle();
    }
	...
	((org.jogamp.java3d.RotationInterpolator)wrapped).setMaximumAngle( angle );
    }
	...
	return ((org.jogamp.java3d.RotationInterpolator)wrapped).getMaximumAngle();
    }
