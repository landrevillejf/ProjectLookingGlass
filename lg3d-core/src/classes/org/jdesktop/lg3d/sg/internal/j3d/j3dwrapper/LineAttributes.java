...
public class LineAttributes extends NodeComponent implements LineAttributesWrapper {
	...
	wrapped = new org.jogamp.java3d.LineAttributes();
    ...
    public void setLineWidth(float lineWidth) {
        ((org.jogamp.java3d.LineAttributes)wrapped).setLineWidth(lineWidth);
    }
    ...
    public float getLineWidth() {
        return ((org.jogamp.java3d.LineAttributes)wrapped).getLineWidth();
    }
    ...
    public void setLinePattern(int linePattern) {
        ((org.jogamp.java3d.LineAttributes)wrapped).setLinePattern(linePattern);
    }
    ...
    public int getLinePattern() {
        return ((org.jogamp.java3d.LineAttributes)wrapped).getLinePattern();
    }
    ...
    public void setPatternMask(int mask) {
        ((org.jogamp.java3d.LineAttributes)wrapped).setPatternMask(mask);
    }
    ...
    public int getPatternMask() {
        return ((org.jogamp.java3d.LineAttributes)wrapped).getPatternMask();
    }
    ...
    public void setPatternScaleFactor(int scaleFactor) {
        ((org.jogamp.java3d.LineAttributes)wrapped).setPatternScaleFactor(scaleFactor);
    }
    ...
    public int getPatternScaleFactor() {
        return ((org.jogamp.java3d.LineAttributes)wrapped).getPatternScaleFactor();
    }
    ...
    public void setLineAntialiasingEnable(boolean state) {
        ((org.jogamp.java3d.LineAttributes)wrapped).setLineAntialiasingEnable(state);
    }
    ...
    public boolean getLineAntialiasingEnable() {
        return ((org.jogamp.java3d.LineAttributes)wrapped).getLineAntialiasingEnable();
    }
