  ...
  */
  ...
  public static final int
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.DirectionalLight();
   ...
   */
    public void setDirection(Vector3f direction) {
        ((org.jogamp.java3d.DirectionalLight)wrapped).setDirection( direction );
    }
   ...
   */
    public void setDirection(float x, float y, float z) {
        ((org.jogamp.java3d.DirectionalLight)wrapped).setDirection( x,y,z );
  }
   ...
   */
    public void getDirection(Vector3f direction) {
        ((org.jogamp.java3d.DirectionalLight)wrapped).getDirection( direction );
    }
