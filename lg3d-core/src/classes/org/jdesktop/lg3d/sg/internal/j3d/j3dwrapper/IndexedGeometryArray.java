...
public abstract class IndexedGeometryArray extends GeometryArray implements IndexedGeometryArrayWrapper {
  ...
  public static final int
    ...
    */
    public int getIndexCount(){
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getIndexCount();
    }
    ...
    public void setValidIndexCount(int validIndexCount) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setValidIndexCount(validIndexCount);
    }
    ...
    public int getValidIndexCount() {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getValidIndexCount();
    }
    ...
    public void setInitialIndexIndex(int initialIndexIndex) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setInitialIndexIndex(initialIndexIndex);
    }
    ...
    public int getInitialIndexIndex() {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getInitialIndexIndex();
    }
  ...
  public void setCoordinateIndex(int index, int coordinateIndex) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setCoordinateIndex( index, coordinateIndex );
  }
  ...
  public void setCoordinateIndices(int index, int coordinateIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setCoordinateIndices( index, coordinateIndices );
  }
  ...
  public void setColorIndex(int index, int colorIndex) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setColorIndex( index, colorIndex );
  }
  ...
  public void setColorIndices(int index, int colorIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setColorIndices( index, colorIndices );
  }
  ...
  public void setNormalIndex(int index, int normalIndex) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setNormalIndex( index, normalIndex );
  }
  ...
  public void setNormalIndices(int index, int normalIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setNormalIndices( index, normalIndices );
  }
    ...
    public void setTextureCoordinateIndex(int texCoordSet,
					  int index,
					  int texCoordIndex) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setTextureCoordinateIndex( texCoordSet,
					   index,
					   texCoordIndex );
    }
    ...
    public void setTextureCoordinateIndices(int texCoordSet,
					    int index,
					    int texCoordIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).setTextureCoordinateIndices( texCoordSet,
					     index,
					     texCoordIndices );
    }
  ...
  public int getCoordinateIndex(int index) {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getCoordinateIndex( index );
  }
  ...
  public void getCoordinateIndices(int index, int coordinateIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getCoordinateIndices( index, coordinateIndices );
  }
  ...
  public int getColorIndex(int index) {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getColorIndex( index );
  }
  ...
  public void getColorIndices(int index, int colorIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getColorIndices( index, colorIndices );
  }
  ...
  public int getNormalIndex(int index) {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getNormalIndex( index );
  }
  ...
  public void getNormalIndices(int index, int normalIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getNormalIndices( index, normalIndices );
  }
    ...
    public int getTextureCoordinateIndex(int texCoordSet, int index) {
        return ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getTextureCoordinateIndex( texCoordSet, index );
    }
    ...
    public void getTextureCoordinateIndices(int texCoordSet,
					    int index,
					    int texCoordIndices[]) {
        ((org.jogamp.java3d.IndexedGeometryArray)wrapped).getTextureCoordinateIndices( texCoordSet,
					     index,
					     texCoordIndices );
    }
