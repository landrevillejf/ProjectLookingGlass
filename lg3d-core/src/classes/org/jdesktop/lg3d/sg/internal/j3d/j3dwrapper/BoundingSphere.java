...
public class BoundingSphere extends Bounds implements BoundingSphereWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.BoundingSphere();
	...
	return (float)((org.jogamp.java3d.BoundingSphere)wrapped).getRadius();
    }
	...
	((org.jogamp.java3d.BoundingSphere)wrapped).getCenter( tmp );
	...
	((org.jogamp.java3d.BoundingSphere)wrapped).set( ((Bounds)boundsObject).wrapped );
    }
	...
	return ((org.jogamp.java3d.BoundingSphere)wrapped).equals( bounds );
    }
     ...
     */
    public int hashCode() {
	return ((org.jogamp.java3d.BoundingSphere)wrapped).hashCode();
    }
    ...
    public void combine(BoundsWrapper boundsObject) {
        ((org.jogamp.java3d.BoundingSphere)wrapped).combine( ((Bounds)boundsObject).wrapped );
    }
	...
	((org.jogamp.java3d.BoundingSphere)wrapped).transform( ((Bounds)boundsObject).wrapped, ((Transform3D)matrix).wrapped );
    }
	...
	((org.jogamp.java3d.BoundingSphere)wrapped).transform( ((Transform3D)trans).wrapped );
    }
...
//
//	return ((org.jogamp.java3d.BoundingSphere)wrapped).intersect( origin, direction );
//    }
...
//	return ((org.jogamp.java3d.BoundingSphere)wrapped).intersect( point );
//    }
	...
	return ((org.jogamp.java3d.BoundingSphere)wrapped).intersect( new Point3d(point) );
	...
	return ((org.jogamp.java3d.BoundingSphere)wrapped).isEmpty();
    }
	...
	return ((org.jogamp.java3d.BoundingSphere)wrapped).intersect( ((Bounds)boundsObject).wrapped );
    }
	...
	return ((org.jogamp.java3d.BoundingSphere)wrapped).toString();
    
    }
    
    public void setCenter(Point3f center) {
	((org.jogamp.java3d.BoundingSphere)wrapped).setCenter(new Point3d(center));
    }
    
    public void setRadius(float radius) {
	((org.jogamp.java3d.BoundingSphere)wrapped).setRadius(radius);
    }
