...
public class Group extends Node implements GroupWrapper {
    ...
    public void setChild(NodeWrapper child, int index) {
        assert( child!=null );
	((org.jogamp.java3d.Group)wrapped).setChild( (org.jogamp.java3d.Node)((Node)child).wrapped, index );
    }
    ...
    public void insertChild(NodeWrapper child, int index) {
        assert( child!=null );
	((org.jogamp.java3d.Group)wrapped).insertChild( (org.jogamp.java3d.Node)((Node)child).wrapped, index );
    }
	...
	((org.jogamp.java3d.Group)wrapped).removeChild( index );
    }
	...
	return (NodeWrapper)((org.jogamp.java3d.Group)wrapped).getChild( index ).getUserData();
    }
	...
	java.util.Iterator e = ((org.jogamp.java3d.Group)wrapped).getAllChildren();
        Vector list = new Vector( ((org.jogamp.java3d.Group)wrapped).numChildren() );
        
        while(e.hasNext()) {
            list.add( ((org.jogamp.java3d.Node)e.next()).getUserData() );
        }
    ...
    public void addChild(NodeWrapper child) {
        assert( child!=null );
	((org.jogamp.java3d.Group)wrapped).addChild( (org.jogamp.java3d.Node)((Node)child).wrapped );
    }
	...
	((org.jogamp.java3d.Group)wrapped).moveTo( (org.jogamp.java3d.BranchGroup)((BranchGroup)branchGroup).wrapped );
    }
	...
	return ((org.jogamp.java3d.Group)wrapped).numChildren();
    }
    ...
    public int indexOfChild(NodeWrapper child) {
        return ((org.jogamp.java3d.Group)wrapped).indexOfChild( (org.jogamp.java3d.Node)((Node)child).wrapped );
    }
    ...
    public void removeChild(NodeWrapper child) {
        assert( child!=null );
        ((org.jogamp.java3d.Group)wrapped).removeChild( (org.jogamp.java3d.Node)((Node)child).wrapped );
    }
    ...
    public void removeAllChildren() {
        ((org.jogamp.java3d.Group)wrapped).removeAllChildren();
    }
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.Group();
