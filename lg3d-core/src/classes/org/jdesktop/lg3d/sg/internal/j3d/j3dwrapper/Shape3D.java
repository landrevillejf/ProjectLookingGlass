...
public class Shape3D extends Leaf implements Shape3DWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.Shape3D();
	...
	((org.jogamp.java3d.Shape3D)wrapped).setGeometry((org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped);
    }
	...
	return (Geometry)((org.jogamp.java3d.Shape3D)wrapped).getGeometry().getUserData();
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).setGeometry((org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped, index);
    }
	...
	return (Geometry)((org.jogamp.java3d.Shape3D)wrapped).getGeometry(index).getUserData();
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).insertGeometry( (org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped, index);
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).removeGeometry(index);
    }
    ...
    public Enumeration getAllGeometries() {
        java.util.Iterator e = ((org.jogamp.java3d.Shape3D)wrapped).getAllGeometries();
        Vector list = new Vector();
        
        while( e.hasNext() )
            list.add( ((org.jogamp.java3d.Geometry)e.next()).getUserData() );
	...
	((org.jogamp.java3d.Shape3D)wrapped).addGeometry((org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped);
    }
	...
	return ((org.jogamp.java3d.Shape3D)wrapped).numGeometries();
    }
	...
	return ((org.jogamp.java3d.Shape3D)wrapped).indexOfGeometry(((org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped));
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).removeGeometry(((org.jogamp.java3d.Geometry)((Geometry)geometry).wrapped));
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).removeAllGeometries();
    }
	...
	((org.jogamp.java3d.Shape3D)wrapped).setAppearance((org.jogamp.java3d.Appearance)((Appearance)appearance).wrapped);
    }
     ...
     */
     public AppearanceWrapper getAppearance() {
        org.jogamp.java3d.Appearance app = ((org.jogamp.java3d.Shape3D)wrapped).getAppearance();
        if (app==null)
            return null;
	...
	boolean ret = ((org.jogamp.java3d.Shape3D)wrapped).intersect(
                        (org.jogamp.java3d.SceneGraphPath)path.wrapped, 
                        (org.jogamp.java3d.PickRay)pickRay.wrapped, 
                        tmp);
    ...
    public boolean intersect(SceneGraphPath path,
        ...
        boolean ret = ((org.jogamp.java3d.Shape3D)wrapped).intersect(
                        (org.jogamp.java3d.SceneGraphPath)path.wrapped, 
                        (org.jogamp.java3d.PickShape)pickShape.wrapped, 
                        tmp);
