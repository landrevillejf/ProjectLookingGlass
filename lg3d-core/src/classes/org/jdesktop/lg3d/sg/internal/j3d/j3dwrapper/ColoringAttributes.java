...
public class ColoringAttributes extends NodeComponent implements ColoringAttributesWrapper {
	...
	wrapped = new org.jogamp.java3d.ColoringAttributes();
	...
	((org.jogamp.java3d.ColoringAttributes)wrapped).setColor( color );
    }
	...
	((org.jogamp.java3d.ColoringAttributes)wrapped).setColor( r,g,b );
    }
	...
	((org.jogamp.java3d.ColoringAttributes)wrapped).getColor(color);
    }
	...
	((org.jogamp.java3d.ColoringAttributes)wrapped).setShadeModel( shadeModel );
    }
	...
	return ((org.jogamp.java3d.ColoringAttributes)wrapped).getShadeModel();
    }
