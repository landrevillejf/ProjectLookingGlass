...
public abstract class NodeComponent extends SceneGraphObject implements NodeComponentWrapper{
   ...
   */
	...
	((org.jogamp.java3d.NodeComponent)wrapped).setDuplicateOnCloneTree(duplicate);
    }
   ...
   */
	...
	return ((org.jogamp.java3d.NodeComponent)wrapped).getDuplicateOnCloneTree();
    }
   ...
   */
    public void duplicateNodeComponent(NodeComponent originalNodeComponent,
        ...
        ((org.jogamp.java3d.NodeComponent)wrapped).duplicateNodeComponent( 
                                            (org.jogamp.java3d.NodeComponent)originalNodeComponent.wrapped, 
                                            forceDuplicate );
    }
