...
public abstract class Bounds implements BoundsWrapper {
    ...
    org.jogamp.java3d.Bounds wrapped;    
     ...
     *
     */    
    protected static final WeakHashMap<org.jogamp.java3d.Bounds, Bounds> reverseLookup = new WeakHashMap();
     ...
     */   
    static Bounds getLGBounds( org.jogamp.java3d.Bounds j3dBounds ) {       
    ...
    void changeWrapped(org.jogamp.java3d.Bounds newBounds) {
