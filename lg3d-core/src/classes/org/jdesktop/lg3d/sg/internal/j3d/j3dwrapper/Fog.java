...
public abstract class Fog extends Leaf implements FogWrapper {
	...
	((org.jogamp.java3d.Fog)wrapped).setColor( color );
    }
	...
	((org.jogamp.java3d.Fog)wrapped).setColor( r,g,b );
    }
	...
	((org.jogamp.java3d.Fog)wrapped).getColor( color );
    }
    ...
    public void setInfluencingBounds(BoundsWrapper region) {
    	((org.jogamp.java3d.Fog)wrapped).setInfluencingBounds( ((Bounds)region).wrapped );
    }
    ...
    public BoundsWrapper getInfluencingBounds() {
    	org.jogamp.java3d.Bounds j3dBounds = ((org.jogamp.java3d.Fog)wrapped).getInfluencingBounds();
...
//    }
	...
	((org.jogamp.java3d.Fog)wrapped).setScope( (org.jogamp.java3d.Group)((Group)scope).wrapped, index );
    }
	...
	return (Group)((org.jogamp.java3d.Fog)wrapped).getScope(index).getUserData();
    }
	...
	((org.jogamp.java3d.Fog)wrapped).insertScope( (org.jogamp.java3d.Group)((Group)scope).wrapped, index );
    }
	...
	((org.jogamp.java3d.Fog)wrapped).removeScope( index );
    }
	...
	java.util.Iterator e = ((org.jogamp.java3d.Fog)wrapped).getAllScopes();
        java.util.Vector v = new java.util.Vector();
        while(e.hasNext())
            v.add( ((GroupWrapper)e.next()).getUserData() );
	...
	((org.jogamp.java3d.Fog)wrapped).addScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
    }
	...
	return ((org.jogamp.java3d.Fog)wrapped).numScopes();
     }
	...
	return ((org.jogamp.java3d.Fog)wrapped).indexOfScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
     }
	...
	((org.jogamp.java3d.Fog)wrapped).removeScope( (org.jogamp.java3d.Group)((Group)scope).wrapped );
    }
	...
	((org.jogamp.java3d.Fog)wrapped).removeAllScopes();
    }
