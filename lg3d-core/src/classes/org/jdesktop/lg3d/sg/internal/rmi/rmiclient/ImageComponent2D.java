...
//
//        wrapped = new org.jogamp.java3d.ImageComponent2D( format, image );
...
//        ((org.jogamp.java3d.ImageComponent2D)wrapped).set( new SerializableRenderedImage(image) );
//    }
...
//        return ((org.jogamp.java3d.ImageComponent2D)wrapped).getImage();
//    }
    ...
    public RenderedImage getRenderedImage() {
        //return ((org.jogamp.java3d.ImageComponent2D)wrapped).getRenderedImage();
...
//        ((org.jogamp.java3d.ImageComponent2D)wrapped).setSubImage( new javax.media.jai.remote.SerializableRenderedImage(image),
//                                                                 width,
//                                                                 height,
//                                                                 srcX,
//                                                                 srcY,
...
//        ((org.jogamp.java3d.ImageComponent2D)wrapped).updateData( updater,
//                                                                x,y,
//                                                                width,
//                                                                height );
                               throw new RuntimeException("Not Implemented");
     ...
     * @since Java 3D 1.3
     */
    public static interface Updater extends org.jogamp.java3d.ImageComponent2D.Updater {
	/**
	 * Updates image data that is accessed by reference.
