...
public class GLSLShaderProgram extends ShaderProgram implements GLSLShaderProgramWrapper {
    ...
    public void createWrapped() {
        wrapped = new org.jogamp.java3d.GLSLShaderProgram();
    }
    ...
    public void setVertexAttrNames(String[] vertexAttrNames) {
        ((org.jogamp.java3d.GLSLShaderProgram)wrapped).setVertexAttrNames(vertexAttrNames);
    }

    // Implement abstract getVertexAttrNames method (inherit javadoc from parent class)
    public String[] getVertexAttrNames() {
	return ((org.jogamp.java3d.GLSLShaderProgram)wrapped).getVertexAttrNames();
    }
    ...
    public void setShaderAttrNames(String[] shaderAttrNames) {
        ((org.jogamp.java3d.GLSLShaderProgram)wrapped).setShaderAttrNames(shaderAttrNames);
    }

    // Implement abstract getShaderAttrNames method (inherit javadoc from parent class)
    public String[] getShaderAttrNames() {
	return ((org.jogamp.java3d.GLSLShaderProgram)wrapped).getShaderAttrNames();
    }
    ...
    public void setShaders(ShaderWrapper[] shaders) {
        org.jogamp.java3d.Shader[] j3dShaders = new org.jogamp.java3d.Shader[shaders.length];
        for(int i=0; i<shaders.length; i++) {
            j3dShaders[i]=(org.jogamp.java3d.Shader)((Shader)shaders[i]).wrapped;
        }
                    
 	((org.jogamp.java3d.GLSLShaderProgram)wrapped).setShaders(j3dShaders);
    }

    // Implement abstract getShaders method (inherit javadoc from parent class)
    public ShaderWrapper[] getShaders() {
        org.jogamp.java3d.Shader[] j3dShaders = ((org.jogamp.java3d.GLSLShaderProgram)wrapped).getShaders();
