...
public class Switch extends Group implements SwitchWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.Switch();
	...
	((org.jogamp.java3d.Switch)wrapped).setWhichChild(child);
    }
	...
	return ((org.jogamp.java3d.Switch)wrapped).getWhichChild();
    }
	...
	((org.jogamp.java3d.Switch)wrapped).setChildMask(childMask);
    }
	...
	return ((org.jogamp.java3d.Switch)wrapped).getChildMask();
    }
	...
	org.jogamp.java3d.Node j3dNode = ((org.jogamp.java3d.Switch)wrapped).currentChild();
        if (j3dNode==null)
            return null;
        else
