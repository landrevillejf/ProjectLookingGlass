...
public class Alpha extends NodeComponent implements AlphaWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.Alpha();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).pause( time );
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).resume();
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).isPaused();
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getPauseTime();
    }
     ...
     */
    public float value() {
	return ((org.jogamp.java3d.Alpha)wrapped).value();
    }
    ...
    public float value(long atTime) {
        return ((org.jogamp.java3d.Alpha)wrapped).value(atTime);
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getStartTime();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setStartTime( startTime );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getLoopCount();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setLoopCount( loopCount );
    }
    ...
    /**
      ...
      */
    public int getMode() {
	return ((org.jogamp.java3d.Alpha)wrapped).getMode();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setMode(mode);
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getTriggerTime();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setTriggerTime( triggerTime );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getPhaseDelayDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setPhaseDelayDuration( phaseDelayDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getIncreasingAlphaDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setIncreasingAlphaDuration( increasingAlphaDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getIncreasingAlphaRampDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setIncreasingAlphaRampDuration( increasingAlphaRampDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getAlphaAtOneDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setAlphaAtOneDuration( alphaAtOneDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getDecreasingAlphaDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setDecreasingAlphaDuration( decreasingAlphaDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getDecreasingAlphaRampDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setDecreasingAlphaRampDuration( decreasingAlphaRampDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).getAlphaAtZeroDuration();
    }
	...
	((org.jogamp.java3d.Alpha)wrapped).setAlphaAtZeroDuration( alphaAtZeroDuration );
    }
	...
	return ((org.jogamp.java3d.Alpha)wrapped).finished();
    }
}
