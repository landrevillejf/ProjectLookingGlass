...
public class TextureAttributes extends NodeComponent implements TextureAttributesWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.TextureAttributes();
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setTextureMode( textureMode );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getTextureMode();
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setTextureBlendColor( textureBlendColor );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setTextureBlendColor( r,g,b,a );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).getTextureBlendColor( textureBlendColor );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setTextureTransform( (org.jogamp.java3d.Transform3D)((Transform3D)transform).wrapped );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).getTextureTransform( (org.jogamp.java3d.Transform3D)((Transform3D)transform).wrapped );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setPerspectiveCorrectionMode( mode );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getPerspectiveCorrectionMode();
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setTextureColorTable( table );
    }
    ...
    public void getTextureColorTable(int[][] table) {
        ((org.jogamp.java3d.TextureAttributes)wrapped).getTextureColorTable( table );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getNumTextureColorTableComponents();
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getTextureColorTableSize();
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineRgbMode( combineMode );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineAlphaMode( combineMode );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineRgbMode();
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineAlphaMode();
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineRgbSource( index, src );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineAlphaSource( index, src );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineRgbSource( index );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineAlphaSource( index );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineRgbFunction( index, function );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineAlphaFunction( index, function );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineRgbFunction( index );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineAlphaFunction( index );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineRgbScale( scale );
    }
	...
	((org.jogamp.java3d.TextureAttributes)wrapped).setCombineAlphaScale( scale );
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineRgbScale();
    }
	...
	return ((org.jogamp.java3d.TextureAttributes)wrapped).getCombineAlphaScale();
    }
