...
public final class PickSegment extends PickShape {
    ...
    public PickSegment(Point3f start, Point3f end) {        
        wrapped = new org.jogamp.java3d.PickSegment( new Point3d(start), new Point3d(end));        
    }
    ...
    public void set(Point3f start, Point3f end) {        
        ((org.jogamp.java3d.PickSegment)wrapped).set( new Point3d(start), new Point3d(end));        
    }
    ...
    public void get(Point3f start, Point3f end) {
        ...
        ((org.jogamp.java3d.PickSegment)wrapped).get( startd, endd );        
        start.set(startd);        
        end.set(endd);        
    }
