...
public class Locale extends Object {
    ...
    org.jogamp.java3d.Locale wrapped;
     ...
     * @deprecated
     */
    public Locale(org.jogamp.java3d.Locale locale ) {
        wrapped = locale;
    }
...
//    }
	...
	wrapped.addBranchGraph( (org.jogamp.java3d.BranchGroup)branchGroup.wrapped );
    }
	...
	wrapped.removeBranchGraph( (org.jogamp.java3d.BranchGroup)branchGroup.wrapped );
    }
	...
	wrapped.replaceBranchGraph( (org.jogamp.java3d.BranchGroup)oldGroup.wrapped, 
                                    (org.jogamp.java3d.BranchGroup)newGroup.wrapped );
    }
	...
	java.util.Iterator e = wrapped.getAllBranchGraphs();
        Vector list = new Vector( wrapped.numBranchGraphs() );
        
        while(e.hasNext()) {
            list.add( ((org.jogamp.java3d.BranchGroup)e.next()).getUserData() );
        }
    ...
    public SceneGraphPath[] pickAll( PickShape pickShape ) {
        org.jogamp.java3d.SceneGraphPath[] j3dSGP = wrapped.pickAll( (org.jogamp.java3d.PickShape)pickShape.wrapped );
        if (j3dSGP==null)
            return null;
    ...
    public SceneGraphPath[] pickAllSorted( PickShape pickShape ) {
        org.jogamp.java3d.SceneGraphPath[] j3dSGP = wrapped.pickAllSorted( (org.jogamp.java3d.PickShape)pickShape.wrapped );
        if (j3dSGP==null)
            return null;
        SceneGraphPath[] ret = new SceneGraphPath[j3dSGP.length];
