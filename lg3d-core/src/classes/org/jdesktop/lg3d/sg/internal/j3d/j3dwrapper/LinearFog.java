...
public class LinearFog extends Fog implements LinearFogWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.LinearFog();
    ...
    public void setFrontDistance(float frontDistance) {
    	((org.jogamp.java3d.LinearFog)wrapped).setFrontDistance(frontDistance);
    }
    ...
    public float getFrontDistance() {
    	return (float)((org.jogamp.java3d.LinearFog)wrapped).getFrontDistance();
    }
    ...
    public void setBackDistance(float backDistance) {
    	((org.jogamp.java3d.LinearFog)wrapped).setBackDistance(backDistance);
    }
    ...
    public float getBackDistance() {
    	return (float)((org.jogamp.java3d.LinearFog)wrapped).getBackDistance();
    }
