...
public class BoundingSphere extends Bounds implements BoundingSphereWrapper {
	...
	//((org.jogamp.java3d.BoundingSphere)wrapped).set( boundsObject.wrapped );
    }
    ...
    public void combine(BoundsWrapper boundsObject) {
        //((org.jogamp.java3d.BoundingSphere)wrapped).combine( boundsObject.wrapped );
...
//	((org.jogamp.java3d.BoundingSphere)wrapped).transform( boundsObject.wrapped, matrix.wrapped );
        throw new RuntimeException("Not Implemented");
    }
...
//	((org.jogamp.java3d.BoundingSphere)wrapped).transform( trans.wrapped );
        throw new RuntimeException("Not Implemented");
    }
...
//    }
    ...
    public boolean intersect(BoundsWrapper boundsObject) {
        throw new RuntimeException("Not Implemented");
//	return ((org.jogamp.java3d.BoundingSphere)wrapped).intersect( boundsObject.wrapped );
    }
