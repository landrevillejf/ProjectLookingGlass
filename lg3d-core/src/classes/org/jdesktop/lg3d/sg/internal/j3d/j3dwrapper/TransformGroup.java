...
public class TransformGroup extends Group implements TransformGroupWrapper {
  ...
  public static final int
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.TransformGroup();
	...
	((org.jogamp.java3d.TransformGroup)wrapped).setTransform( ((Transform3D)t1).wrapped );
    }
   ...
   */
    ...
    public void getTransform(Transform3DWrapper t1) {
        ...
        ((org.jogamp.java3d.TransformGroup)wrapped).getTransform( ((Transform3D)t1).wrapped );
