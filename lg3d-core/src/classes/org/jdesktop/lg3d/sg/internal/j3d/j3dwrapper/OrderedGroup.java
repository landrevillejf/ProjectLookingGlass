...
public class OrderedGroup extends Group implements OrderedGroupWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.OrderedGroup();
        wrapped.setUserData(this);
    }
    
    public void addChild(org.jdesktop.lg3d.sg.internal.wrapper.NodeWrapper child, int[] childIndexOrder) {
        ((org.jogamp.java3d.OrderedGroup)wrapped).addChild( (org.jogamp.java3d.Node)child.getWrapped(), childIndexOrder );
    }
    
    public int[] getChildIndexOrder() {
        return ((org.jogamp.java3d.OrderedGroup)wrapped).getChildIndexOrder();
    }
    
    public void setChildIndexOrder(int[] childIndexOrder) {
        ((org.jogamp.java3d.OrderedGroup)wrapped).setChildIndexOrder(childIndexOrder);
    }
