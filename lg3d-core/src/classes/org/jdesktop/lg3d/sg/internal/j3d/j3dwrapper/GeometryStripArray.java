...
public abstract class GeometryStripArray extends GeometryArray {
	...
	return ((org.jogamp.java3d.GeometryStripArray)wrapped).getNumStrips();
    }
	...
	((org.jogamp.java3d.GeometryStripArray)wrapped).setStripVertexCounts(stripVertexCounts);
    }
	...
	((org.jogamp.java3d.GeometryStripArray)wrapped).getStripVertexCounts(stripVertexCounts);
    }
