...
public final class PickRay extends PickShape {
     ...
     */
    public PickRay() {
	wrapped = new org.jogamp.java3d.PickRay();
	...
	wrapped = new org.jogamp.java3d.PickRay( new Point3d(origin), 
	...
	((org.jogamp.java3d.PickRay)wrapped).set( new Point3d(origin), 
                                                new Vector3d(direction) );
    }
	...
	((org.jogamp.java3d.PickRay)wrapped).get( p3d, v3d );
