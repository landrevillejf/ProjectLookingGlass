...
public class TransparencyOrderedGroup extends Group implements TransparencyOrderedGroupWrapper {
    ...
    public void addChild(NodeWrapper child, int[] childIndexOrder) {
        assert( child!=null );
	((org.jdesktop.j3d.utils.scenegraph.transparency.TransparencyOrderedGroup)wrapped).addChild( (org.jogamp.java3d.Node)((Node)child).wrapped, childIndexOrder );
    }

    public void addChild(NodeWrapper child) {
        assert( child!=null );
	((org.jdesktop.j3d.utils.scenegraph.transparency.TransparencyOrderedGroup)wrapped).addChild( (org.jogamp.java3d.Node)((Node)child).wrapped );
    }

    public void insertChild(NodeWrapper child, int index) {
        assert( child!=null );
	((org.jdesktop.j3d.utils.scenegraph.transparency.TransparencyOrderedGroup)wrapped).insertChild( (org.jogamp.java3d.Node)((Node)child).wrapped, index );
    }

    public void setChild(NodeWrapper child, int index) {
        assert( child!=null );
	((org.jdesktop.j3d.utils.scenegraph.transparency.TransparencyOrderedGroup)wrapped).setChild( (org.jogamp.java3d.Node)((Node)child).wrapped, index );
    }

    public void removeChild(NodeWrapper child) {
        assert( child!=null );
	((org.jdesktop.j3d.utils.scenegraph.transparency.TransparencyOrderedGroup)wrapped).removeChild( (org.jogamp.java3d.Node)((Node)child).wrapped );
    }
