...
public class Texture2D extends Texture implements Texture2DWrapper {
	...
	wrapped = new org.jogamp.java3d.Texture2D();
   ...
   */
	...
	wrapped = new org.jogamp.java3d.Texture2D(mipMapMode, format, width, height);
        wrapped.setUserData( this );
    }
    ...
    public Texture2D(int          mipMapMode,
                   ...
                   int          boundaryWidth) {
        assert(this.getClass()==Texture2D.class);
	wrapped = new org.jogamp.java3d.Texture2D(mipMapMode, format, width, height, boundaryWidth);
        wrapped.setUserData( this );
    }
	...
	((org.jogamp.java3d.Texture2D)wrapped).setMagFilter( magFilter );
    }
    ...
    public void setDetailImage(ImageComponent2DWrapper detailTexture) {
        ((org.jogamp.java3d.Texture2D)wrapped).setDetailImage( (org.jogamp.java3d.ImageComponent2D)((ImageComponent2D)detailTexture).wrapped );
    }
    ...
    public ImageComponent2DWrapper getDetailImage() {
        return (ImageComponent2DWrapper)((org.jogamp.java3d.Texture2D)wrapped).getDetailImage().getUserData();
    }
    ...
    public void setDetailTextureMode(int mode) {
        ((org.jogamp.java3d.Texture2D)wrapped).setDetailTextureMode( mode );
    }
    ...
    public int getDetailTextureMode() {
       return ((org.jogamp.java3d.Texture2D)wrapped).getDetailTextureMode();
    }
    ...
    public void setDetailTextureLevel(int level) {
        ((org.jogamp.java3d.Texture2D)wrapped).setDetailTextureLevel( level );
    }
    ...
    public int getDetailTextureLevel() {
       return ((org.jogamp.java3d.Texture2D)wrapped).getDetailTextureLevel();
    }
    ...
    public void setDetailTextureFunc(float[] lod, float[] pts) {
        ((org.jogamp.java3d.Texture2D)wrapped).setDetailTextureFunc( lod, pts );
    }
    ...
    public void setDetailTextureFunc(Point2f[] pts) {
        ((org.jogamp.java3d.Texture2D)wrapped).setDetailTextureFunc( pts );
    }
    ...
    public int getDetailTextureFuncPointsCount() {
        return ((org.jogamp.java3d.Texture2D)wrapped).getDetailTextureFuncPointsCount();
    }
    ...
    public void getDetailTextureFunc(float[] lod, float[] pts) {
        ((org.jogamp.java3d.Texture2D)wrapped).getDetailTextureFunc( lod, pts );
    }
