...
public abstract class Node extends SceneGraphObject implements NodeWrapper {
    ...
    public NodeWrapper getParent() {
        org.jogamp.java3d.Node parent = ((org.jogamp.java3d.Node)wrapped).getParent();
        if (parent==null)
            return null;
	...
	((org.jogamp.java3d.Node)wrapped).setBounds( ((Bounds)bounds).wrapped );
    }
    ...
    public BoundsWrapper getBounds() {
        ...
        org.jogamp.java3d.Bounds j3dB = ((org.jogamp.java3d.Node)wrapped).getBounds();
        if (j3dB==null)
            return null;
        ...
        if (ret!=null)
            return ret;
        else if (j3dB instanceof org.jogamp.java3d.BoundingSphere) {
        ...
        } else if (j3dB instanceof org.jogamp.java3d.BoundingBox) {
	...
	((org.jogamp.java3d.Node)wrapped).setBoundsAutoCompute(autoCompute);
    }
	...
	return ((org.jogamp.java3d.Node)wrapped).getBoundsAutoCompute();
    }
	...
	((org.jogamp.java3d.Node)wrapped).getLocalToVworld(((Transform3D)t).wrapped);
    }
	...
	((org.jogamp.java3d.Node)wrapped).getLocalToVworld(((SceneGraphPath)path).wrapped,((Transform3D)t).wrapped);
    }
	...
	((org.jogamp.java3d.Node)wrapped).setPickable( pickable );
    }
	...
	return ((org.jogamp.java3d.Node)wrapped).getPickable();
    }
