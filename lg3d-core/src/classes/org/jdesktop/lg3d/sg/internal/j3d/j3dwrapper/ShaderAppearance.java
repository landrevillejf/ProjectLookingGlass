...
public class ShaderAppearance extends Appearance implements ShaderAppearanceWrapper {
    ...
    protected void createWrapped() {
        wrapped = new org.jogamp.java3d.ShaderAppearance();
    ...
    public void setShaderProgram(ShaderProgramWrapper shaderProgram) {
        if (shaderProgram==null)
            ((org.jogamp.java3d.ShaderAppearance)wrapped).setShaderProgram(null);
        else
            ((org.jogamp.java3d.ShaderAppearance)wrapped).setShaderProgram((org.jogamp.java3d.ShaderProgram)((ShaderProgramWrapper)shaderProgram).getWrapped());
    }
    ...
    public void setShaderAttributeSet(ShaderAttributeSetWrapper shaderAttributeSet) {
        if (shaderAttributeSet==null)
            ((org.jogamp.java3d.ShaderAppearance)wrapped).setShaderAttributeSet(null);
        else
            ((org.jogamp.java3d.ShaderAppearance)wrapped).setShaderAttributeSet((org.jogamp.java3d.ShaderAttributeSet)shaderAttributeSet.getWrapped());
    }
