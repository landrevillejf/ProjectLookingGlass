...
public class TransparencyAttributes extends NodeComponent implements TransparencyAttributesWrapper {
	...
	wrapped = new org.jogamp.java3d.TransparencyAttributes();
    ...
    public void setTransparencyMode(int transparencyMode) {
        ((org.jogamp.java3d.TransparencyAttributes)wrapped).setTransparencyMode(transparencyMode);
    }
	...
	return ((org.jogamp.java3d.TransparencyAttributes)wrapped).getTransparencyMode();
    }
    ...
    public void setTransparency(float transparency) {
        ((org.jogamp.java3d.TransparencyAttributes)wrapped).setTransparency(transparency);
    }
	...
	return ((org.jogamp.java3d.TransparencyAttributes)wrapped).getTransparency();
    }
    ...
    public void setSrcBlendFunction(int blendFunction) {
        ((org.jogamp.java3d.TransparencyAttributes)wrapped).setSrcBlendFunction(blendFunction);
    }
	...
	return ((org.jogamp.java3d.TransparencyAttributes)wrapped).getSrcBlendFunction();
    }
    ...
    public void setDstBlendFunction(int blendFunction) {
        ((org.jogamp.java3d.TransparencyAttributes)wrapped).setDstBlendFunction(blendFunction);
    }
	...
	return ((org.jogamp.java3d.TransparencyAttributes)wrapped).getDstBlendFunction();
    }
