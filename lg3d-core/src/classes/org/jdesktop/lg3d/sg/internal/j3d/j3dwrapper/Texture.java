...
public abstract class Texture extends NodeComponent implements TextureWrapper {
	...
	((org.jogamp.java3d.Texture)wrapped).setBoundaryModeS( boundaryModeS );
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getBoundaryModeS();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setBoundaryModeT( boundaryModeT );
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getBoundaryModeT();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMinFilter( minFilter );
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getMinFilter();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMagFilter( magFilter );
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getMagFilter();
    }
    ...
    public void setImage(int level, ImageComponentWrapper image) {
        if (image==null)
            ((org.jogamp.java3d.Texture)wrapped).setImage( level, null );
        else
            ((org.jogamp.java3d.Texture)wrapped).setImage( level, (org.jogamp.java3d.ImageComponent)((ImageComponent)image).wrapped );
    }
	...
	org.jogamp.java3d.ImageComponent j3dIC = ((org.jogamp.java3d.Texture)wrapped).getImage( level );
    ...
    public void setImages(ImageComponentWrapper[] images) {
        org.jogamp.java3d.ImageComponent[] j3dImages = new org.jogamp.java3d.ImageComponent[images.length];
        
        for(int i=0; i<images.length; i++)
            j3dImages[i] = (org.jogamp.java3d.ImageComponent)((ImageComponent)images[i]).wrapped;
        
	((org.jogamp.java3d.Texture)wrapped).setImages( j3dImages );
    }
    ...
    public ImageComponentWrapper[] getImages() {
        org.jogamp.java3d.ImageComponent[] j3dImages = ((org.jogamp.java3d.Texture)wrapped).getImages();
	...
	return ((org.jogamp.java3d.Texture)wrapped).getFormat();
    }
     ...
     */
    public int getWidth() {
	return ((org.jogamp.java3d.Texture)wrapped).getWidth();
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getHeight();
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getBoundaryWidth();
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).numMipMapLevels();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMipMapMode(mipMapMode);
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getMipMapMode();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setEnable(state);
    }
	...
	return ((org.jogamp.java3d.Texture)wrapped).getEnable();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setBoundaryColor(boundaryColor);
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setBoundaryColor( r,g,b,a );
    }
	...
	((org.jogamp.java3d.Texture)wrapped).getBoundaryColor(boundaryColor);
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setBaseLevel(baseLevel);
    }
    ...
    public int getBaseLevel() {
        return ((org.jogamp.java3d.Texture)wrapped).getBaseLevel();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMaximumLevel(maximumLevel);
    }
    ...
    public int getMaximumLevel() {
        return ((org.jogamp.java3d.Texture)wrapped).getMaximumLevel();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMinimumLOD(minimumLod);
    }
    ...
    public float getMinimumLOD() {
        return ((org.jogamp.java3d.Texture)wrapped).getMinimumLOD();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setMaximumLOD(maximumLod);
    }
    ...
    public float getMaximumLOD() {
        return ((org.jogamp.java3d.Texture)wrapped).getMaximumLOD();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setLodOffset( s,t,r );
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setLodOffset( offset );
    }
    ...
    public void getLodOffset(Tuple3f offset) {
        ((org.jogamp.java3d.Texture)wrapped).getLodOffset(offset);
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setAnisotropicFilterMode( mode );
    }
    ...
    public int getAnisotropicFilterMode() {
        return ((org.jogamp.java3d.Texture)wrapped).getAnisotropicFilterMode();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setAnisotropicFilterDegree( degree );
    }
    ...
    public float getAnisotropicFilterDegree() {
        return ((org.jogamp.java3d.Texture)wrapped).getAnisotropicFilterDegree();
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setSharpenTextureFunc( lod, pts );
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setSharpenTextureFunc( pts );
    }
    ...
    public int getSharpenTextureFuncPointsCount() {
        return ((org.jogamp.java3d.Texture)wrapped).getSharpenTextureFuncPointsCount();
    }
    ...
    public void getSharpenTextureFunc(float[] lod, float[] pts) {
        ((org.jogamp.java3d.Texture)wrapped).getSharpenTextureFunc( lod,pts);
    }
    ...
    public void getSharpenTextureFunc(Point2f[] pts) {
        ((org.jogamp.java3d.Texture)wrapped).getSharpenTextureFunc(pts);
    }
	...
	((org.jogamp.java3d.Texture)wrapped).setFilter4Func( weights );
    }
    ...
    public int getFilter4FuncPointsCount() {
        return ((org.jogamp.java3d.Texture)wrapped).getFilter4FuncPointsCount();
    }
    ...
    public void getFilter4Func(float[] weights) {
        ((org.jogamp.java3d.Texture)wrapped).getFilter4Func( weights );
    }
