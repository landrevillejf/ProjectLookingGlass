...
//                    "Please upgrade to version "+compileJavaVersion+" or newer.");
        ...
        try {
            Class clazz = Class.forName("org.jogamp.java3d.utils.pickfast.PickCanvas"/*, false, logger.getClass().getClassLoader()*/);
            (new SplashStarter()).start();
            new ServerHandler();
            SplashWindow.destroySplashscreen();
        } catch (ClassNotFoundException cnfe) {
            Package j3dPackage = Package.getPackage("org.jogamp.java3d");
