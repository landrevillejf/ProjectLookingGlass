...
public class DisplayServerControl implements DisplayServerAppInterface, DisplayServerManagerInterface {
    ...
    private org.jogamp.java3d.BranchGroup mgmtBG;
    ...
    public void initialize(int maxFramesPerSecond) {        
	    ...
	    // load the configuration from the URL
            ...
            wrapped = new org.jogamp.java3d.utils.universe.ConfiguredUniverse();
        }
	...
	// create the viewing information
        ...
        mgmtBG = new org.jogamp.java3d.BranchGroup();
...
//        org.jogamp.java3d.TransformGroup j3dTG = wrapped.getViewingPlatform().getViewPlatformTransform();
...
//        }
    ...
    private void processAllConfig() {
        ...
        try {
            ...
            // Install the global Swing window-capture hook now, before any
            // conventional app opens a JFrame. It otherwise installs lazily on
            // the first SwingNode (StickyNote, created only on window flip), so
            // a start-menu-launched app's frame could escape to the host
            // desktop. Idempotent.
            org.jdesktop.lg3d.wg.internal.swingnode.SwingNodeWindowCapture.ensureHookInstalled();
     ...
     */
    private void initializeFoundationWinSys( org.jogamp.java3d.Canvas3D[] canvas,
                                     org.jogamp.java3d.Locale locale, 
				     org.jogamp.java3d.BranchGroup mgmtBG, 
	...
	try {
		...
		new Class[] { org.jogamp.java3d.Canvas3D[].class,
			      org.jogamp.java3d.Locale.class,
			      ViewInfo.class,
    ...
    private void waitForCanvas3D() {
        ...
        org.jogamp.java3d.BranchGroup bg = new org.jogamp.java3d.BranchGroup();
        bg.setCapability(org.jogamp.java3d.BranchGroup.ALLOW_DETACH);
	...
	org.jogamp.java3d.Transform3D tmpT3d = new org.jogamp.java3d.Transform3D();
	org.jogamp.java3d.Canvas3D[] canvses = wrapped.getViewer().getCanvas3Ds();
	...
	org.jogamp.java3d.Transform3D j3dT3d = new org.jogamp.java3d.Transform3D(matrix);
     ...
     */
    private org.jogamp.java3d.BranchGroup getImplementationNode(BranchGroup lgBg) {
        Object obj;
        SceneGraphObjectWrapper w = lgBg.getWrapped();
        org.jogamp.java3d.BranchGroup ret = null;
        ...
        while (ret == null) {
            ...
            else if (obj instanceof org.jogamp.java3d.BranchGroup)
                ret = (org.jogamp.java3d.BranchGroup)obj;
        }
	 ...
	 */
        public Canvas3dCheck(Semaphore canvas3dRunning) {
            ...
            setSchedulingBounds(new org.jogamp.java3d.BoundingSphere(new Point3d(), Double.POSITIVE_INFINITY));
        }
	 ...
	 * @param en (not used)
	 */
        public void processStimulus(java.util.Iterator<org.jogamp.java3d.WakeupCriterion> en) {
    ...
    public void printSceneNode (org.jogamp.java3d.SceneGraphObject sgo, int level) {
	...
	/* For debug
	if (sgo instanceof org.jogamp.java3d.TransformGroup) {
	    org.jogamp.java3d.TransformGroup tg = (org.jogamp.java3d.TransformGroup) sgo;
	    org.jogamp.java3d.Transform3D t3d = new org.jogamp.java3d.Transform3D();
	    tg.getTransform(t3d);
	...
	*/
	...
	if (sgo instanceof org.jogamp.java3d.Group) {
	    org.jogamp.java3d.Group group = (org.jogamp.java3d.Group) sgo;
	    //System.err.println("group = " + group);
	    if (group.getCapability(org.jogamp.java3d.Group.ALLOW_CHILDREN_READ)) {
		//System.err.println("group = " + group);
		java.util.Iterator e = group.getAllChildren();
		if (e != null) {
		    while (e.hasNext()) {
			org.jogamp.java3d.SceneGraphObject child = 
			    (org.jogamp.java3d.SceneGraphObject) e.next();
	...
	org.jogamp.java3d.Group j3dGroup = (org.jogamp.java3d.Group) j3dGraphNode.getChild(1);
    ...
    class TestDistanceComparator implements Comparator {
        ...
        private org.jogamp.java3d.Transform3D trans1;
        private org.jogamp.java3d.Transform3D trans2;
        private Point3d p1;
        private Point3d p2;
        ...
        public TestDistanceComparator() {
            trans1 = new org.jogamp.java3d.Transform3D();
            trans2 = new org.jogamp.java3d.Transform3D();
            p1 = new Point3d();
            p2 = new Point3d();
        }
    ...
    class PerformanceMonitorBehavior extends Behavior {
        ...
        public void processStimulus(java.util.Iterator<org.jogamp.java3d.WakeupCriterion> e) {
            frameCount++;
