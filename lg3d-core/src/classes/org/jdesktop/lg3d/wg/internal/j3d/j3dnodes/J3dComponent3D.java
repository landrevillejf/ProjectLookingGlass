...
public class J3dComponent3D extends J3dLgBranchGroup {
    ...
    public void removeAllChildren() {
        java.util.Iterator e = children.getAllChildren();
        if (this instanceof J3dContainer3D) {
            while (e.hasNext()) {
                Object child = e.next();
                assert(child instanceof J3dComponent3D);
     ...
     * list of children with the specified child.
     */
    public org.jogamp.java3d.Node getChildLG(int index) {
     ...
     */
    public org.jogamp.java3d.Node getChild(int index) {
        if (index==0)
            return getDecoGroup();
        else
    ...
    public Enumeration getAllChildrenLG() {
        ...
        java.util.Iterator e = children.getAllChildren();
        while (e.hasNext()) {
            org.jogamp.java3d.Node j3dC3d = ((org.jogamp.java3d.Node)e.next());
            if (j3dC3d==null)
                collection.add(null);
            else {
...
//                            j3dC3d.getUserData()).getUserData();
    ...
    public java.util.Iterator<org.jogamp.java3d.Node> getAllChildren() {
        java.util.List<org.jogamp.java3d.Node> collection = new java.util.ArrayList<org.jogamp.java3d.Node>();
        collection.add(getDecoGroup());
        java.util.Iterator e = children.getAllChildren();
        while(e.hasNext())
            collection.add((org.jogamp.java3d.Node)e.next());
