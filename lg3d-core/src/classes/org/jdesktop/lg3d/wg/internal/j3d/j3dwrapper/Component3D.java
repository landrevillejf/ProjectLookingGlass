...
//    }
	...
	((J3dComponent3D)wrapped).addChildLG((org.jogamp.java3d.Node)child.getWrapped());
    }
	...
	//checkChildClass(child);
	((J3dComponent3D)wrapped).setChildLG((org.jogamp.java3d.Node)child.getWrapped(), index);
    }
    ...
    public void insertChild(NodeWrapper child, int index) {
        //checkChildClass(child);
	((J3dComponent3D)wrapped).insertChildLG((org.jogamp.java3d.Node)child.getWrapped(), index);
    }
	...
	//checkChildClass(child);
	((J3dComponent3D)wrapped).moveTo((org.jogamp.java3d.BranchGroup)child.getWrapped());
    }
	...
	((J3dComponent3D)wrapped).removeChild((org.jogamp.java3d.Node)child.getWrapped());
    }
    ...
    public Enumeration getAllChildren() {
        ...
        org.jogamp.java3d.Node node;
        
        while(e.hasMoreElements()) {
            node = (org.jogamp.java3d.Node)e.nextElement();
            if (node!=null)
	...
	return ((J3dComponent3D)wrapped).indexOfChildLG((org.jogamp.java3d.Node)child.getWrapped());
    }

    public void setTransform(org.jdesktop.lg3d.sg.internal.wrapper.Transform3DWrapper t3d) {
        ((J3dComponent3D)wrapped).setTransform((org.jogamp.java3d.Transform3D)((org.jdesktop.lg3d.sg.internal.j3d.j3dwrapper.Transform3D)t3d).getWrapped());
    }
}
