 ...
 * @author  Paul
 */
public class J3dLgBranchGroup extends org.jogamp.java3d.BranchGroup implements LgEventSource {
    ...
    private static Class[] targetsForSetCapabilities = {
        Shape3D.class, org.jogamp.java3d.Morph.class
    };
    ...
    public J3dLgBranchGroup() {
        super();
        setCapability( org.jogamp.java3d.BranchGroup.ENABLE_PICK_REPORTING );
    }
		...
		public boolean changeNode(Node node) {
                    try {
                        if (node instanceof Shape3D ||
                            node instanceof org.jogamp.java3d.Morph)
