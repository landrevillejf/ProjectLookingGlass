...
public class AnimationGroup extends TransformGroup {
	 ...
	 */	
        public org.jogamp.vecmath.Vector3f getTranslation(org.jogamp.vecmath.Vector3f pos) {
            if (pos == null) {
	 ...
	 */	
        public org.jogamp.vecmath.AxisAngle4f getRotation(org.jogamp.vecmath.AxisAngle4f rot) {
            if (rot == null) {
                throw new IllegalArgumentException("argument cannot be null");
            }
            rot.set(rotation);
