 ...
 */
public class Prefuse3DRadialLayout extends TreeLayout implements FocusListener {
    ...
    public Prefuse3DRadialLayout(Prefuse3D orgChart) {
    ...
    public void run(ItemRegistry registry, double frac) {
        ...
        //System.out.println("#### origin= " + m_origin + " " + m_radiusInc);
    ...
    protected void setPolarLocation(NodeItem n, double r, double theta) {
        ...
        double x =  + 0.1*Math.cos(theta);
        double y =  + 0.1*Math.sin(theta);
        n.setVizAttribute(Prefuse3DRenderer.ATTR_X, new Float(x));
        n.setVizAttribute(Prefuse3DRenderer.ATTR_Y, new Float(y));
        n.setVizAttribute(Prefuse3DRenderer.ATTR_Z, 0.0f);
        //System.out.println("#### set trans=" + r + " " +x + " " + y);
...
} // end of class Prefuse3DRadialLayout
