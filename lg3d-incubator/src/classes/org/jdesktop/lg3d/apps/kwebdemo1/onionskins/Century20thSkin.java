/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/onionskins/Century20thSkin.java,v 1.2 2005-06-24 19:57:01 paulby Exp $
...
/**
 * Onionskin nested sphere, nodes and edges related to the 20th Century skin
 * 
 * @author Jim Zaun &lt;jz-lg@zaun.com&gt; (a.k.a. &lt;zaun@acm.org&gt;)
 * @version $Revision: 1.2 $
 * @since JDK 1.5.0, Java3D 1.4.0, lg3d-{core,demo,incubator} 0.7.0
 */
public class Century20thSkin extends Onionskin
{
    /**
     * Century number for this onion skin.  (It happens to be 20 but you should
     * use this constant even though I ignore my own advise and use 20 anyway.)
     */
   ...
   */
  public Century20thSkin(float radius, Color3f color)
  {
