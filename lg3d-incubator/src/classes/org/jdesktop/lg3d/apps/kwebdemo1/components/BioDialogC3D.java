/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/BioDialogC3D.java,v 1.5 2006-12-13 22:01:36 paulby Exp $
...
import org.jdesktop.lg3d.apps.kwebdemo1.events.BioDialogMouseClickedAction;
 ...
 */
public class BioDialogC3D extends Component3D
{
  ...
  private BasicNode currentKNode = null;
  ...
  final URL dialog01 =
    getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/bioN1168.png");
  final URL dialog02 =
    getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/bioH1168.png");
  final URL dialog03 =
   ...
   */
  public BioDialogC3D(Application app)
  {
    super();
    this.app = app;
  ...
  public void zoomIntoView(int millisecs, int nextStep, BasicNode kn)
  {
    ...
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.01f, 0f, -3f),
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.01f, 0f, 0.1f),
  ...
  public void handleMouseClick()
  {
    ...
    switch (step)
      {
      case 10: changeTexture(dialog02); step = 99;
      /* no break */ sleep(1000);
      default: app.bioDialogSequence(2, id, currentKNode); 
      }
  }
  ...
  private AnimationGroup createDialog()
  {
    ...
    try
      {
        dialogShape3D = createDialogShape3D(dialog00, 0.15f, 0.1125f);
   ...
   * {@link org.jdesktop.lg3d.apps.kwebdemo1.events.BioDialogMouseClickedAction BioDialogMouseClickedAction}. 
   */
  private void addMouseClickedListener()
  {
    addListener(new MouseClickedEventAdapter(
                  new BioDialogMouseClickedAction(this)));
  }
