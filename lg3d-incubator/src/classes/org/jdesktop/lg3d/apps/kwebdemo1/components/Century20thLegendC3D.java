/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/Century20thLegendC3D.java,v 1.4 2006-12-13 22:01:38 paulby Exp $
 * $Date: 2006-12-13 22:01:38 $
 *
...
/**
 * The component that handles the "20th Century History" flying title animation
 ...
 */
public class Century20thLegendC3D extends Component3D
{
  private Application app = null;
  private BranchGroup cent20BG = null;
  private AnimationGroup cent20AG = null;
   ...
   */
  public Century20thLegendC3D(Application app)
  {
    super();
    this.app = app;
    cent20BG = new BranchGroup();
    cent20AG = createLabel();
    cent20BG.addChild(cent20AG);
    this.addChild(cent20BG);
  }
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(0.021f, 0.02f, 0.2f),
                                      millisecs);
    cent20AG.setAnimation(zoomIntoViewTA);
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.021f, 0.02f, 0.2f),
                                      new Vector3f(0f, 0f, 0.8f),
                                      millisecs,
                                      new AcceleratingVector3fSmoother());
    cent20AG.setAnimation(zoomOutOfViewTA);
   ...
   * <code>ImagePanel</code> that has the "20th Century History" title textured
   * onto it.
   * 
  ...
  private AnimationGroup createLabel()
  {
    ...
    try
      {
        URL imageFilename 
          = getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Century20thHistory.png");
        ImagePanel splash 
      ...
      {
        System.err.println("Kwebdemo1 Century20thLegendC3D createLabel(): " +
                           e.toString());
      }
    catch (IOException e)
      {
