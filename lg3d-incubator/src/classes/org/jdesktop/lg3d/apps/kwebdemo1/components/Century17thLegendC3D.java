/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/Century17thLegendC3D.java,v 1.4 2006-12-13 22:01:36 paulby Exp $
...
/**
 * The component that handles the "17th Century History" flying title animation
 ...
 */
public class Century17thLegendC3D extends Component3D
{
  private Application app = null;
  private BranchGroup cent17BG = null;
  private AnimationGroup cent17AG = null;
   ...
   */
  public Century17thLegendC3D(Application app)
  {
    super();
    this.app = app;
    cent17BG = new BranchGroup();
    cent17AG = createLabel();
    cent17BG.addChild(cent17AG);
    this.addChild(cent17BG);
  }
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    TranslationAnimationBoolean zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(0.01f, -0.01f, 0.2f),
                                      millisecs);
    cent17AG.setAnimation(zoomIntoViewTA);
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.01f, -0.01f, 0.2f),
                                      new Vector3f(0f, 0f, 0.8f),
                                      millisecs,
                                      new AcceleratingVector3fSmoother());
    cent17AG.setAnimation(zoomOutOfViewTA);
   ...
   * <code>ImagePanel</code> that has the "17th Century History" title textured
   * onto it.
   * 
  ...
  private AnimationGroup createLabel()
  {
    ...
    try
      {
        URL imageFilename 
          = getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Century17thHistory.png");
        ImagePanel splash 
          = new ImagePanel(imageFilename, 0.05f, 0.025f);
        ag.addChild(splash);
      }
    catch (FileNotFoundException e)
      {
        System.err.println("Kwebdemo1 Century17thLegendC3D createLabel(): " +
                           e.toString());
      }
    catch (IOException e)
      {
