/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/JourneyDialogC3D.java,v 1.5 2006-12-13 22:01:39 paulby Exp $
...
import org.jdesktop.lg3d.apps.kwebdemo1.events.JourneyDialogMouseClickedAction;
import org.jdesktop.lg3d.apps.kwebdemo1.events.JourneyDialogSequenceAction;
...
/**
 * The component that handles the journey dialog animation.
 * 
 ...
 */
public class JourneyDialogC3D extends Component3D
{
  ...
  final URL dialog00 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Journey00.png");
  final URL dialog01 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Journey01.png");
  final URL dialog02 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Journey02.png");
  final URL dialog03 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart03.png");
  final URL dialog04 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart04.png");
  final URL dialog05 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart05.png");
  final URL dialog06 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart06.png");
  final URL dialog07 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart07.png");
  final URL dialog08 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart08.png");
  final URL dialog09 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart09.png");
  final URL dialog10 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart10.png");
  final URL dialog11 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart11.png");
  final URL dialog12 =
    getClass().getResource("org/jdesktop/lg3d/apps/kwebdemo1/resources/images/journeyMozart12.png");
   ...
   */
  public JourneyDialogC3D(Application app)
  {
    super();
    this.app = app;
  ...
  {
  	switch (app.journeyIdx)
	  {
  	  case 1: changeTexture(dialog01); break;
  	  case 2: changeTexture(dialog02); break;
  	  default: changeTexture(dialog00);
	  };
    this.setVisible(true);
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(-0.02f, 0.01f, 0.11f),
                                      millisecs);
    ...
    LgEventConnector.getLgEventConnector().addListener(zoomIntoViewTA,
            new GenericEventAdapter(LgEvent.class,
                                    new JourneyDialogSequenceAction(app, nextStep))
            );
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(-0.02f, 0.01f, 0.11f),
  ...
  public void handleMouseClick()
  {
    ...
    switch (step)
      {
      default: app.journeyDialogSequence(2);   
      }
  }
  ...
  private AnimationGroup createDialog()
  {
    ...
    dialogBox = new GlassyPanel(0.095f, 0.095f, 0.005f, boxApp);
    AnimationGroup ag = new AnimationGroup();
    ag.addChild(dialogBox);
    try
      {
        dialogShape3D = createDialogShape3D(dialog00, 0.095f, 0.095f);
        ag.addChild(dialogShape3D);
      }
    catch (FileNotFoundException e)
      {
        System.err.println("Kwebdemo1 JourneyDialog(): " +
                           e.toString());
      }
    catch (IOException e)
      {
   ...
   * {@link org.jdesktop.lg3d.apps.kwebdemo1.events.JourneyDialogMouseClickedAction JourneyDialogMouseClickedAction}. 
   */
  private void addMouseClickedListener()
  {
    addListener(new MouseClickedEventAdapter(
                  new JourneyDialogMouseClickedAction(this)));
  }
