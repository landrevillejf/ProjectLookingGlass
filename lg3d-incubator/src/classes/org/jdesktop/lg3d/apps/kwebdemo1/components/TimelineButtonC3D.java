/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/TimelineButtonC3D.java,v 1.4 2006-12-13 22:01:40 paulby Exp $
...
/**
 * The component that handles the Timeline button animation at the begining of
 * the startup sequence and all the UI actions with the button.
 * 
 * <p>The purpose of the Timeline button is to show a popup dialog that allows
 * the user to see an how people, things and events relate to each other in
 * time.  It is also another search dialog in that it lets you select a
 * person, thing or event to visit in the KWeb.</p>
 * 
 ...
 */
public class TimelineButtonC3D extends Component3D
{
   ...
   */
  public TimelineButtonC3D(Application app)
  {
    super();
    this.app = app;
    ...
    addMouseReleasedListener(app, "Timeline");
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    buttonTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(-0.125f, 0.0625f, -0.15f),
                                      millisecs);
  ...
  private AnimationGroup createIcon()
  {
    ...
    try
      {
        buttonIP 
          = new ImagePanel(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/TimeN_64x64.png"), 0.0125f, 0.0125f);
  ...
  private void addMouseRolloverListener()
  {
    ...
    try
      {
        app.setTexture(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/TimeR_64x64.png"));
      ...
      {
        System.err.println(
                "Kwebdemo1 TimelineButtonC3D addMouseRolloverListener(): " +
                e.toString());
      }
    catch (IOException e)
      {
  ...
  try
    {
      app.setTexture(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/TimeS_64x64.png"));
    ...
    {
      System.err.println(
              "Kwebdemo1 TimelineButtonC3D addMousePressedListener(): " +
              e.toString());
    }
  catch (IOException e)
    {
