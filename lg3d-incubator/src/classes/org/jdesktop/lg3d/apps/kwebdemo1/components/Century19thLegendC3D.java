/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/Century19thLegendC3D.java,v 1.4 2006-12-13 22:01:37 paulby Exp $
 * $Date: 2006-12-13 22:01:37 $
 *
...
/**
 * The component that handles the "19th Century History" flying title animation
 ...
 */
public class Century19thLegendC3D extends Component3D
{
  private Application app = null;
  private BranchGroup cent19BG = null;
  private AnimationGroup cent19AG = null;
   ...
   */
  public Century19thLegendC3D(Application app)
  {
    super();
    this.app = app;
    cent19BG = new BranchGroup();
    cent19AG = createLabel();
    cent19BG.addChild(cent19AG);
    this.addChild(cent19BG);
  }
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(0.022f, 0.01f, 0.2f),
                                      millisecs);
    cent19AG.setAnimation(zoomIntoViewTA);
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.022f, 0.01f, 0.2f),
                                      new Vector3f(0f, 0f, 0.8f),
                                      millisecs,
                                      new AcceleratingVector3fSmoother());
    cent19AG.setAnimation(zoomOutOfViewTA);
   ...
   * <code>ImagePanel</code> that has the "19th Century History" title textured
   * onto it.
   * 
  ...
  private AnimationGroup createLabel()
  {
    ...
    try
      {
        URL imageFilename 
          = getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Century19thHistory.png");
        ImagePanel splash 
      ...
      {
        System.err.println("Kwebdemo1 Century19thLegendC3D createLabel(): " +
                           e.toString());
      }
    catch (IOException e)
      {
