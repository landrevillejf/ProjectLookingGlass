/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/Century18thLegendC3D.java,v 1.4 2006-12-13 22:01:37 paulby Exp $
...
/**
 * The component that handles the "18th Century History" flying title animation
 ...
 */
public class Century18thLegendC3D extends Component3D
{
  private Application app = null;
  private BranchGroup cent18BG = null;
  private AnimationGroup cent18AG = null;
   ...
   */
  public Century18thLegendC3D(Application app)
  {
    super();
    this.app = app;
    cent18BG = new BranchGroup();
    cent18AG = createLabel();
    cent18BG.addChild(cent18AG);
    this.addChild(cent18BG);
  }
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(0.025f, 0f, 0.2f),
                                      millisecs);
    cent18AG.setAnimation(zoomIntoViewTA);
  ...
  {
    zoomOutOfViewTA =
      new TranslationAnimationBoolean(new Vector3f(0.025f, 0f, 0.2f),
                                      new Vector3f(0f, 0f, 0.8f),
                                      millisecs,
                                      new AcceleratingVector3fSmoother());
    cent18AG.setAnimation(zoomOutOfViewTA);
   ...
   * <code>ImagePanel</code> that has the "18th Century History" title textured
   * onto it.
   * 
  ...
  private AnimationGroup createLabel()
  {
    ...
    try
      {
        URL imageFilename 
          = getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/Century18thHistory.png");
        ImagePanel splash 
      ...
      {
        System.err.println("Kwebdemo1 Century18thLegendC3D createLabel(): " +
                           e.toString());
      }
    catch (IOException e)
      {
