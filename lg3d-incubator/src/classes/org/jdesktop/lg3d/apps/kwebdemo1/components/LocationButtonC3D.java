/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/LocationButtonC3D.java,v 1.4 2006-12-13 22:01:40 paulby Exp $
...
/**
 * The component that handles the geographic Location button animation at the
 * begining of the startup sequence and all the UI actions with the button.
 * 
 * <p>The purpose of the Location button is to show a popup map or earth globe
 * or both (maybe globe first then a more detailed map as you click into it)
 * that allows the user where people, things and events happened in space. We
 * were thinking of using historical map overlays onto 3-D terrain
 * visualizations since this technology already exists.
 * </p>
 * 
 ...
 */
public class LocationButtonC3D extends Component3D
{
   ...
   */
  public LocationButtonC3D(Application app)
  {
    super();
    this.app = app;
    ...
    addMouseReleasedListener(app, "Location");
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    buttonTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      new Vector3f(-0.125f, 0.04375f, -0.15f),
                                      millisecs);
  ...
  private AnimationGroup createIcon()
  {
    ...
    try
      {
        buttonIP 
          = new ImagePanel(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/GeoN_64x64.png"), 0.0125f, 0.0125f);
  ...
  private void addMouseRolloverListener()
  {
    ...
    try
      ...
      {
        System.err.println(
                "Kwebdemo1 LocationButtonC3D addMouseRolloverListener(): " +
                e.toString());
      }
    catch (IOException e)
      {
  ...
  try
    {
      app.setTexture(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/GeoS_64x64.png"));
    ...
    {
      System.err.println(
              "Kwebdemo1 LocationButtonC3D addMousePressedListener(): " +
              e.toString());
    }
  catch (IOException e)
    {
