/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/components/CloseButtonC3D.java,v 1.4 2006-12-13 22:01:38 paulby Exp $
...
/**
 * The component that handles the close button animation at the
 * begining of the startup sequence and all the UI actions with the button.
 * 
 * <p>The purpose of the close button is to display credits and close the
 * application.
 * </p>
 * 
 ...
 */
public class CloseButtonC3D extends Component3D
{
   ...
   */
  public CloseButtonC3D(Application app)
  {
    super();
    this.app = app;
    ...
    addMouseReleasedListener(app, "Close");
  ...
  public void zoomIntoView(int millisecs, int nextStep)
  {
    zoomIntoViewTA =
      new TranslationAnimationBoolean(new Vector3f(0f, 0f, 0.8f),
                                      ...
                                      millisecs);
    buttonAG.setAnimation(zoomIntoViewTA);
  ...
  private AnimationGroup createIcon()
  {
    ...
    try
      {
        buttonIP 
          = new ImagePanel(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/CloseN_64x64.png"), 0.0125f, 0.0125f);
  ...
  private void addMouseRolloverListener()
  {
    ...
    try
      {
        app.setTexture(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/CloseR_64x64.png"));
      ...
      {
        System.err.println(
                "Kwebdemo1 CloseButtonC3D addMouseRolloverListener(): " +
                e.toString());
      }
    catch (IOException e)
      {
  ...
  try
    {
      app.setTexture(getClass().getResource("/org/jdesktop/lg3d/apps/kwebdemo1/resources/images/icon/CloseS_64x64.png"));
    ...
    {
      System.err.println(
              "Kwebdemo1 CloseButtonC3D addMousePressedListener(): " +
              e.toString());
    }
  catch (IOException e)
    {
