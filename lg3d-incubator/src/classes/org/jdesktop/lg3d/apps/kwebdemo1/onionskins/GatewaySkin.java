/*
 * $Header: /zpool01/javanet/scm/svn/tmp/cvs2svn/lg3d-incubator/src/classes/org/jdesktop/lg3d/apps/kwebdemo1/onionskins/GatewaySkin.java,v 1.2 2005-06-24 19:57:01 paulby Exp $
...
/**
 * Onionskin nested sphere, nodes and edges related to the outermost Gateway skin
 * 
 * @author Jim Zaun &lt;jz-lg@zaun.com&gt; (a.k.a. &lt;zaun@acm.org&gt;)
 * @version $Revision: 1.2 $
 * @since JDK 1.5.0, Java3D 1.4.0, lg3d-{core,demo,incubator} 0.7.0
 */
public class GatewaySkin extends Onionskin
{
    /**
     * Century number for this onion skin.  (It happens to be 0 but you should
     * use this constant even though I ignore my own advise and use 0 anyway.)
     */
   ...
   */
  public GatewaySkin(float radius, Color3f color)
  {
  ...
  {
    onionTrans.setTransparency(0.5f);
