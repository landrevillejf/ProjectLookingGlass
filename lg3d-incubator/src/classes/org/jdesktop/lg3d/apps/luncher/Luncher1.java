 ...
 */
public class Luncher1 extends Frame3D implements GlassyCardMenuHolder {
    ...
    private float iconSize = luncherWidth*0.05f;
    private GlassyCardMenu menu = null;
    ...
    public Luncher1() {
        menu = new GlassyCardMenu(this);
        menu.setIconSize(iconSize);
        menu.setVisible(false);

        SimpleAppearance app = new SimpleAppearance(0.6f, 1.0f, 0.6f, 1.0f,SimpleAppearance.DISABLE_CULLING);
//        SimpleAppearance app = new SimpleAppearance(0.6f, 1.0f, 0.6f, 0.3f,SimpleAppearance.DISABLE_CULLING);
	...
	GlassyPanel glassyPanel = new GlassyPanel(luncherWidth, luncherHeight, luncherDepth, luncherDepth*0.1f, app);
        ...
        lunchComp.setName("LunchComp");
        lunchComp.addChild(glassyPanel);
//        lunchComp.addChild(cylinder);
