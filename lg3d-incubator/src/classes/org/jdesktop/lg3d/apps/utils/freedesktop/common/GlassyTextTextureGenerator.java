...
class GlassyTextTextureGenerator {
    ...
    public GlassyTextTextureGenerator(String text, float height, float widthScale, 
            int xShift, int yShift,  java.awt.Color backColor) 
    {
        t2d = createTexture(text, height, widthScale, xShift, yShift, backColor);
    }
    ...
    private Texture createTexture(String text, float height, float widthScale, 
            int xShift, int yShift,  java.awt.Color backColor) 
    {
	BufferedImage bi = createTextureImage(text, height, widthScale, xShift, yShift, backColor);
...
//		ic2d.getWidth(), ic2d.getHeight());
    ...
    private BufferedImage createTextureImage(String text, float height, 
            float widthScale, int xShift, int yShift,  java.awt.Color backColor) 
    {
	if (text == null) {
	...
	g2d.setRenderingHints(
        ...
        if(backColor!=null)
        {
            ...
            g2d.fillRoundRect(0,0,textWidth*2,textHeight*2,8,8);
        }
