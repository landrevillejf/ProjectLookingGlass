...
public class EllipseLayout implements LayoutManager3D {
    ...
    public EllipseLayout(float smallr,float bigr,Direction direction) {
        this.direction = direction;
        this.smallr = smallr;
        this.bigr = bigr;
        bGList = new ArrayList<Component3D>();
    }
    public EllipseLayout(float smallr,float bigr,float rotZ,Direction direction) {
        this.direction = direction;
        this.smallr = smallr;
        this.bigr = bigr;
        this.rotZ = rotZ;
    ...
    public EllipseLayout(float smallr,float bigr,float rotZ,Direction direction, float frontScale) {
        this.direction = direction;
	...
	int fixSize = numBg -6;
        ...
        for(int i = 0;i<numBg;i++) {
            ...
            double aa = Math.PI * 2.0 / numBg * idx;
            switch (direction) {
                case HORIZONTAL: {
