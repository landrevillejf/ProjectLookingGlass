...
public class EllipseContainer extends Container3D implements BgSorting{
    ...
    private Component3D leftButton(){
        ...
        ModelLoader model = new ModelLoader(
                modelDir, "pfeil_krumm2.obj", org.jogamp.java3d.loaders.objectfile.ObjectFile.class,m4f);
    ...
    private Component3D rightButton(){
        ...
        ModelLoader model;
        model = new ModelLoader(modelDir, "pfeil_krumm2.obj", org.jogamp.java3d.loaders.objectfile.ObjectFile.class,changeAxis);
        model.setScale(0.005f);
        BranchGroup bg = new BranchGroup();
        bg.addChild( model );
    ...
    private Component3D animButton(){
        ...
        ModelLoader model =  new ModelLoader(modelDir,
                "refresh.obj", org.jogamp.java3d.loaders.objectfile.ObjectFile.class);
