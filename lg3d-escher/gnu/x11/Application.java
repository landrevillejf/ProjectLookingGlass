...
public class Application extends gnu.app.Application {
  ...
  protected Application (String [] args, String clientThreadName) {
    ...
    int send_mode = option.enumerate ("send-mode", "request sending mode", 
      Connection.SEND_MODE_STRINGS, Connection.ASYNCHRONOUS);

    if (help_option) return;
    display = new Display (display_name, clientThreadName);
