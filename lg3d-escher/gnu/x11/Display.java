...
public class Display {
  ...
  /**
   * A native pointer used by LG3D to store key mapping information
   */
  public long userDataHandle = 0;
  ...
  public Display (Name name) {        
    this (name.hostname, name.display_no, name.screen_no, null);
  }

  /**
   * #Display(String, String)
   */
  public Display (Name name, String clientThreadName) {        
    this (name.hostname, name.display_no, name.screen_no, clientThreadName);
  }
  ...
  public Display (String hostname, int display_no) {
    this (hostname, display_no, 0, null);
  }
  ...
  public Display (String hostname, int display_no, int screen_no) {
      this(hostname, display_no, screen_no, null);
  }
  ...
  public Display (String hostname, int display_no, int screen_no,
    ...
    connection = new Connection (this, hostname, display_no, clientThreadName);
  ...
  public boolean checkEventTypeWindow (int code, int wid) {        
    return connection.checkEventTypeWindow(code, wid);
  }

  public void ignore_error (int errCode) {
      connection.ignore_error(errCode);
  }
